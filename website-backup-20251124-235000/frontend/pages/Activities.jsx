      ...
      <div className="relative bg-white border-b border-gray-200 px-4 sm:px-6 py-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="crm-button-group">
            ...
            {canCreate() && (
              <Button variant="default" size="default" className="gap-2 bg-[#761B14] hover:bg-[#6b1a12]">
        ...
        <div className="crm-stats-grid mt-6">
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-5 border border-[#761B14]/30 shadow-md hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs font-semibold text-[#761B14] uppercase tracking-wide">Today</div>
                <div className="text-3xl font-bold text-[#761B14] mt-1">{stats.todayActivities}</div>
              </div>
            </div>
          </div>
        </div>
