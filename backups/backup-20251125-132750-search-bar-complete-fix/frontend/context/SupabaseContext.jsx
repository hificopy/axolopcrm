...
// Global supabase instance for backward compatibility
// Note: This is deprecated - use useSupabase() hook instead
...
export const supabase = {
  get client() {
    if (!globalSupabase) {
      console.warn(
        "supabase.client accessed before initialization. Use useSupabase() hook instead.",
      );
      return null;
    }
