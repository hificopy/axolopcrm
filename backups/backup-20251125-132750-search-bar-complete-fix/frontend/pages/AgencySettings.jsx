      ...
      <div className="p-8">
        ...
        {activeTab === "members" && (
          <div className="space-y-6">
            ...
            {/* Seat Progress Bar */}
            <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 border border-white/10 rounded-xl p-6 mb-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">Team Seat Usage</h3>
                  <p className="text-sm text-gray-400">Manage your team members and subscription</p>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div className="p-3 bg-gray-800/50 rounded-lg border border-white/5">
                  <p className="text-gray-400 text-xs mb-1">Free Seats</p>
                  <p className="text-white font-bold text-lg">3</p>
                  <p className="text-green-400 text-xs">Included</p>
                </div>
                <div className="p-3 bg-gray-800/50 rounded-lg border border-white/5">
                  <p className="text-gray-400 text-xs mb-1">Additional</p>
                  <p className="text-white font-bold text-lg">{Math.max(currentAgency.max_users - 3, 0)}</p>
                  <p className="text-yellow-400 text-xs">${Math.max((currentAgency.max_users - 3) * 12, 0)}/mo</p>
                </div>
                <div className="p-3 bg-gray-800/50 rounded-lg border border-white/5">
                ...
                <div className="p-3 bg-gray-800/50 rounded-lg border border-white/5">
                  ...
                  <p className="text-yellow-400 font-bold text-lg">${Math.max((currentAgency.max_users - 3) * 12, 0)}</p>
                  <p className="text-yellow-400 text-xs">per month</p>
                </div>
              </div>
              ...
              {members.length >= currentAgency.max_users && (
                <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-yellow-400 font-medium">Seat Limit Reached</p>
                        ...
                        {isAdmin() && (
                          <div className="relative">
                            ...
                            {editingMemberId === member.id && (
                              <div className="absolute top-full mt-1 right-0 z-10 bg-gray-800 border border-white/10 rounded-lg shadow-xl p-2 min-w-32">
                                <div className="text-xs text-gray-400 mb-2">Change Role:</div>
