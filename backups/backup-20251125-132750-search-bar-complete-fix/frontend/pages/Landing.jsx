...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <NavigationBar affiliateRef={affiliateRef} affiliateName={affiliateName} />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <motion.div
              ...
              className="mb-6"
            >
              <Badge className="relative overflow-hidden bg-gradient-to-r from-[#4A1515]/40 via-[#4A1515]/30 to-[#4A1515]/20 text-white border-2 border-[#4A1515]/60 backdrop-blur-xl px-4 py-2 text-sm font-bold shadow-lg">
                  ...
                  <div className="p-6 overflow-y-auto h-[calc(100%-4rem)]">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-6">
                      ...
                      <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="text-4xl font-bold text-[#4A1515] mb-2">$125k</div>
                      ...
                      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <div className="h-32 bg-gradient-to-br from-red-50 to-rose-50 rounded-lg flex items-end px-4 pb-4">
                          <div className="flex-1 h-full flex items-end justify-around">
                            <div className="w-8 bg-gradient-to-t from-[#4A1515] to-[#5C1E1E] rounded-t" style={{ height: '60%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#4A1515] to-[#5C1E1E] rounded-t" style={{ height: '75%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#4A1515] to-[#5C1E1E] rounded-t" style={{ height: '65%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#4A1515] to-[#5C1E1E] rounded-t" style={{ height: '85%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#4A1515] to-[#5C1E1E] rounded-t" style={{ height: '90%' }}></div>
                          </div>
                        </div>
                        <div className="grid grid-cols-3 gap-4 mt-4 text-xs">
                          ...
                          <div className="text-center">
                            ...
                            <div className="font-bold text-[#4A1515]">$95,000</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            { label: 'Qualified', value: '175', percent: '70%', color: 'bg-[#5C1E1E]' },
            ...
            <div className="text-center">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-2">
                    <span className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4A1515] via-[#5C1E1E] to-[#4A1515]">$149</span>
                  ...
                  <tr key={i} className="hover:bg-gray-900/40 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      {typeof row.axolop === 'boolean' ? (
                        ...
                        <span className="font-bold text-base text-[#5C1E1E]">{row.axolop}</span>
                      )}
                    </td>
                    <td className="px-6 py-4 text-center">
