...
const settingsNavigation = [
  {
    ...
    sections: [
      ...
      { name: 'Appearance', href: '/app/settings/account?tab=appearance', icon: LayoutDashboard, locked: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'AI Knowledge Sources', href: '/app/settings/customization/ai', icon: Code, locked: true },
    ]
  },
  {
    name: 'Communication',
    icon: Mail,
    sections: [
      { name: 'Phone & Voicemail', href: '/app/settings/communication/phone', icon: Phone, locked: true },
      { name: 'Dialer', href: '/app/settings/communication/dialer', icon: Phone, locked: true },
      { name: 'Outcomes', href: '/app/settings/communication/outcomes', icon: Zap, locked: true },
      { name: 'Notetaker BETA', href: '/app/settings/communication/notetaker', icon: Bell, locked: true },
      { name: 'Email', href: '/app/settings/communication/email', icon: Mail, locked: true },
      { name: 'Templates & Snippets', href: '/app/settings/communication/templates', icon: Mail, locked: true },
      { name: 'Send As', href: '/app/settings/communication/sendas', icon: Mail, locked: true },
    ]
  },
  {
    name: 'Connect',
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Usage', href: '/app/settings/billing/usage', icon: BarChart3, locked: true },
    ]
  }
];
