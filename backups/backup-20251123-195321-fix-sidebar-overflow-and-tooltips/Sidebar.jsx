...
import {
  ...
  TrendingUp, Workflow, Activity, Mail, Layers, Lock, ChevronDown, ChevronRight,
...
export default function Sidebar({ isSidebarCollapsed, setIsSidebarCollapsed, pinnedButtons, onPinnedChange }) {
  ...
  return (
    <div
      className="h-screen w-48 bg-gradient-to-b from-black/95 via-gray-900/90 to-black/95 backdrop-blur-xl flex flex flex-col shadow-2xl border-r border-white/5"
    >
