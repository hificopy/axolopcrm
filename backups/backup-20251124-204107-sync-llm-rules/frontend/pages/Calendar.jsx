          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-[#791C14] to-[#a03a2e] flex items-center justify-center shadow-lg">
              ...
              <div className="flex items-center gap-2 bg-gray-100 rounded-xl p-1.5 w-fit shadow-inner">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 ${
                    calendarMode === 'calendar'
                      ? 'bg-gradient-to-r from-[#791C14] to-[#a03a2e] text-white shadow-lg scale-105'
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2 bg-white rounded-xl px-3 py-2 shadow-sm border border-gray-200">
                <button
                  ...
                  className="px-3 py-1.5 text-sm font-semibold text-gray-700 hover:text-[#791C14] hover:bg-gray-100 rounded-lg transition-all"
                >
                  Today
                </button>
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all ${
                    currentView === 'dayGridMonth'
                      ? 'bg-white text-[#791C14] shadow-md'
              ...
              {canCreate() && (
                <button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-[#791C14] to-[#a03a2e] text-white px-5 py-2.5 rounded-xl hover:shadow-lg transition-all font-semibold shadow-md hover:scale-105"
                >
            ...
            <div className="h-full bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              <style>{`
                ...
                .fc {
                  ...
                  --fc-button-bg-color: #791C14;
                  --fc-button-border-color: #791C14;
                  ...
                  --fc-event-bg-color: #791C14;
                  --fc-event-border-color: #791C14;
                }

                .fc .fc-button-primary {
                  background: linear-gradient(to right, #791C14, #a03a2e);
                  border: none;
