...
export default function Sidebar({ isSidebarCollapsed, setIsSidebarCollapsed, pinnedButtons, onPinnedChange }) {
  ...
  return (
    <div
      className="h-screen w-48 bg-gradient-to-b from-black/95 via-gray-900/90 to-black/95 backdrop-blur-xl flex flex-col shadow-2xl border-r border-white/5 relative"
    >
      ...
      <div className="w-full flex-1 flex flex-col pb-[180px] overflow-hidden">
        ...
        <div className="px-3 py-4 border-b border-gray-800/30 bg-gradient-to-b from-black/20 to-transparent -mt-[7px] flex-shrink-0">
