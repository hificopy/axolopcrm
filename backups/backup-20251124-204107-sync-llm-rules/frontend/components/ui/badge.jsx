...
function Badge({ className, variant = 'default', ...props }) {
  const variants = {
    ...
    accent: 'bg-[#791C14]/10 dark:bg-[#791C14]/20 text-[#791C14] dark:text-[#d4463c] border-[#791C14]/20 dark:border-[#791C14]/40 hover:bg-[#791C14]/15 dark:hover:bg-[#791C14]/30 font-semibold',
    'accent-solid': 'bg-[#791C14] dark:bg-[#6b1a12] text-white border-[#791C14] dark:border-[#6b1a12] hover:bg-[#6b1a12] dark:hover:bg-[#5b1810] shadow-sm',
