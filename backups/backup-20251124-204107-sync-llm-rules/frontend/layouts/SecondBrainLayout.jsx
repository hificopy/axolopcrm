      ...
      <div className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-br from-[hsl(var(--crm-sidebar-gradient-start))] via-[hsl(var(--crm-sidebar-gradient-mid))] to-[hsl(var(--crm-sidebar-gradient-end))] border-r border-gray-800/50 flex flex-col shadow-2xl">
        ...
        <div className="h-24 flex items-center justify-center px-6 border-b border-gray-800/30 bg-gradient-to-b from-black/40 to-transparent backdrop-blur-md">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-[#791C14]/0 via-[#791C14]/10 to-[#791C14]/0 blur-2xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <img
              src="/axolop-logo.png"
              alt="Axolop"
        ...
        <div className="px-3 py-4 border-b border-gray-800/30 bg-gradient-to-b from-black/20 to-transparent">
          ...
          <button
            ...
            className="w-full mt-3 flex items-center justify-center py-2.5 px-3 rounded-lg transition-all duration-300 backdrop-blur-xl bg-gradient-to-r from-[#791C14]/40 via-[#791C14]/30 to-[#791C14]/20 border-2 border-[#791C14]/60 shadow-lg overflow-hidden group"
          >
            ...
            <Link
              ...
              className={`flex items-center justify-center py-2 px-2 rounded-lg transition-all duration-200 ${
                location.pathname === '/dashboard'
                  ? 'bg-gradient-to-r from-[#791C14]/30 via-[#791C14]/20 to-transparent text-white border border-[#791C14] shadow-md'
        ...
        <div className="px-3 py-3 border-t border-gray-800/50">
          <div onClick={openPopup} className="group relative rounded-xl overflow-hidden backdrop-blur-xl bg-gradient-to-br from-[#791C14]/20 via-[#5a1610]/30 to-[#3a0e0a]/40 p-4 border border-[#791C14]/40 shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 cursor-pointer">
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-black/20 pointer-events-none" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#791C14]/0 via-[#791C14]/20 to-[#791C14]/0 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          ...
          <Link
            ...
            className={`flex items-center py-2.5 px-3 rounded-lg transition-all duration-200 ${
              location.pathname.includes('/settings')
                ? 'bg-gradient-to-r from-[#791C14]/30 via-[#791C14]/20 to-transparent text-white border-r-4 border-[#791C14] shadow-lg backdrop-blur-sm font-semibold'
