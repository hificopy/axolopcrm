...
const mainCategories = [
  {
    ...
    icon: DollarSign,
    items: [
      { name: 'Inbox', href: '/app/inbox', icon: Inbox, badge: 48, locked: true, version: 'V1.3' },
      {
        name: 'Leads',
        icon: UserPlus,
        subItems: [
          { name: 'List', href: '/app/leads', icon: UserPlus },
          { name: 'New Custom View', href: '/app/leads/custom-view', icon: Eye, locked: true, version: 'V1.1' },
        ]
      },
      ...
      { name: 'Workflows', href: '/app/workflows', icon: Workflow, locked: true, version: 'V1.1' },
      {
        ...
        subItems: [
          ...
          { name: 'Live Calls', href: '/app/live-calls', icon: Phone, locked: true, version: 'V1.1' },
        ]
      },
      {
        name: 'Activities',
        ...
        subItems: [
          ...
          { name: 'Activity Overview', href: '/app/reports/activity-overview', icon: Activity, locked: true, version: 'V1.1' },
          { name: 'Activity Comparison', href: '/app/reports/activity-comparison', icon: BarChart3, locked: true, version: 'V1.1' },
          { name: 'Opportunity Funnels', href: '/app/reports/opportunity-funnels', icon: TrendingUp, locked: true, version: 'V1.1' },
          { name: 'Status Changes', href: '/app/reports/status-changes', icon: History, locked: true, version: 'V1.1' },
          { name: 'Explorer', href: '/app/reports/explorer', icon: Target, locked: true, version: 'V1.1' },
        ]
      },
    ]
  },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Workflows', href: '/app/workflows', icon: Workflow, locked: true, version: 'V1.1' },
      { name: 'Funnels', href: '/app/funnels', icon: Filter, locked: true, version: 'V1.1' },
      { name: 'Link in Bio', href: '/app/link-in-bio', icon: LinkIcon, locked: true, version: 'V1.1' },
      { name: 'Content', href: '/app/content', icon: Layers, locked: true, version: 'V1.1' },
...
export default function Sidebar({ isSidebarCollapsed, setIsSidebarCollapsed, pinnedButtons, onPinnedChange }) {
  ...
  return (
    <div
      className="h-screen w-48 bg-gradient-to-b from-black/95 via-gray-900/90 to-black/95 backdrop-blur-xl flex flex flex-col shadow-2xl border-r border-white/5 overflow-visible"
    >
      {/* Header section with logo and text */}
      <div className="h-16 bg-transparent flex items-center px-4 rounded-br-2xl -mt-[7px]">
      ...
      <div className="w-full h-full flex flex-col overflow-visible">
        ...
        <div className="px-3 py-4 border-b border-gray-800/30 bg-gradient-to-b from-black/20 to-transparent -mt-[7px]">
          ...
          {/* Navigation */}
          <nav className="flex-1 overflow-y-auto py-2 px-3 scrollbar-thin max-h-[calc(100vh-400px)]">
