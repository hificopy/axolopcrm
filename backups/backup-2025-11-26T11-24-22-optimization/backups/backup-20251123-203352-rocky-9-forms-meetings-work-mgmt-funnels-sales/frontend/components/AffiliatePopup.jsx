  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl shadow-2xl shadow-black/30">
        ...
        <div className="bg-gradient-to-br from-[#791C14] via-[#5a1610] to-[#3d0f0b] rounded-xl border border-white/20">
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <div className="p-5">
            ...
            <div className="mb-4 rounded-lg overflow-hidden bg-black/50 aspect-video relative group border border-white/20">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#ff6b4a]/20 to-[#791C14]/20">
