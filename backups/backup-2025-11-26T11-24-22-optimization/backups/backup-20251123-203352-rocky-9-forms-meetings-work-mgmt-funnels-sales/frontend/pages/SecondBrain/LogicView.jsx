      ...
      <SecondBrainLayout>
        <div className="h-full min-h-screen flex items-center justify-center pt-[150px] bg-gray-50 dark:bg-gray-900">
          <div className="text-center">
            <RefreshCw className="w-12 h-12 text-[#791C14] mx-auto mb-4 animate-spin" />
      ...
      <SecondBrainLayout>
        <div className="h-full min-h-screen flex items-center justify-center pt-[150px] bg-gray-50 dark:bg-gray-900">
          <div className="text-center max-w-md">
            ...
            <button
              onClick={loadData}
              className="px-6 py-3 bg-[#791C14] hover:bg-[#651610] text-white rounded-lg transition-colors"
            >
              Try Again
            </button>
          </div>
      ...
      <div className="relative h-screen w-screen flex flex-col bg-gray-50 dark:bg-gray-900 p-0 m-0">
        ...
        <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
          ...
          <button
            ...
            disabled={isCreating}
            className="flex items-center gap-2 px-3 py-2 bg-[#791C14] hover:bg-[#651610] text-white rounded-lg transition-colors disabled:opacity-50 shadow-lg"
          >
          ...
          {selectedNode && (
            <div className="w-96 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 overflow-y-auto shadow-xl">
              <div className="p-6">
                        ...
                        return connectedNode ? (
                          ...
                          >
                            ...
                            <div className="flex-1 text-left">
                              <div className="text-gray-900 dark:text-white text-sm font-medium group-hover:text-[#791C14] transition-colors">
                                {connectedNode.label}
                              </div>
                              <div className="text-gray-600 dark:text-gray-400 text-xs capitalize">{connectedNode.type}</div>
                            </div>
                            <Link2 className="w-4 h-4 text-gray-400 dark:text-gray-500 group-hover:text-[#791C14] transition-colors" />
                          </button>
                        ) : null;
                      })}
                  </div>
                ...
                {/* Actions */}
                <div className="space-y-2">
                  <button className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#791C14] hover:bg-[#651610] text-white rounded-lg transition-colors shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#791C14]"
            >
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-[#791C14] hover:bg-[#651610] text-white rounded-lg transition-colors disabled:opacity-50"
              disabled={isCreating}
            >
