...
export default function MainLayout() {
  ...
  const [isSidebarCollapsed, setIsSidebarCollapsed] = useState(() => {
    const saved = localStorageGet('axolop_sidebar_collapsed', 'false');
    return saved === 'true';
  });
  ...
  useEffect(() => {
    localStorageSet('axolop_sidebar_collapsed', isSidebarCollapsed.toString());
  }, [isSidebarCollapsed]);
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 transform-gpu relative">
        ...
        <header className="h-10 w-full sticky top-0 z-50 flex items-center justify-between px-6" style={{ background: 'transparent' }}>
