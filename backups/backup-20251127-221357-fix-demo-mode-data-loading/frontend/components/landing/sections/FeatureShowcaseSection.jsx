  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-[#E92C92]/5 rounded-full blur-3xl" />
        ...
        >
          <Link to="/signup">
            ...
            >
              ...
              <ArrowRight className="w-5 h-5 relative z-10" style={{ color: '#ffffff', filter: 'drop-shadow(0px 1px 2px rgba(0,0,0,0.3))' }} />
