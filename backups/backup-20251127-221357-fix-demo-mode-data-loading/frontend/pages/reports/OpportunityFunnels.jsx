            ...
            <div className="flex flex-col items-center justify-center text-center">
              <div className="mb-6">
                ...
                <svg width="300" height="250" viewBox="0 0 300 250">
                  <path d="M 50 20 L 250 20 L 200 80 L 100 80 Z" fill="#e0e7ff" stroke="#3F0D28" strokeWidth="2" />
                  <path d="M 100 80 L 200 80 L 175 140 L 125 140 Z" fill="#c7d2fe" stroke="#3F0D28" strokeWidth="2" />
                  <path d="M 125 140 L 175 140 L 160 200 L 140 200 Z" fill="#a5b4fc" stroke="#3F0D28" strokeWidth="2" />
