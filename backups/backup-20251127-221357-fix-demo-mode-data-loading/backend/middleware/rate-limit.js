...
// Note: RedisStore import removed due to ioredis compatibility issues
...
/**
 * Create rate limiter with memory store only
 * Note: RedisStore disabled due to ioredis compatibility issues with rate-limit-redis v4+
 * Memory store is sufficient for single-instance deployments
 */
function createLimiter(options) {
  ...
  // Using in-memory store for all rate limiting
  // Redis store disabled due to ioredis/rate-limit-redis compatibility issues
