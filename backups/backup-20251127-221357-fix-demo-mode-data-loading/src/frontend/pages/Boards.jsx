        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#761B14] to-[#d4463c] flex items-center justify-center shadow-lg">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-8 text-center shadow-sm">
            <div className="mx-auto h-16 w-16 rounded-full bg-gradient-to-br from-[#761B14]/10 to-[#d4463c]/10 flex items-center justify-center mb-6">
              <Grid3X3 className="h-8 w-8 text-[#d4463c]" />
            </div>
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Kanban-style boards for visual project management. Coming soon
              with integration to popular tools.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <Kanban className="h-6 w-6 text-[#14787b] mb-2" />
                <span className="text-sm font-medium text-gray-700">
                  Kanban
                </span>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <Columns3 className="h-6 w-6 text-[#14787b] mb-2" />
                <span className="text-sm font-medium text-gray-700">
                  Columns
                </span>
              </div>
