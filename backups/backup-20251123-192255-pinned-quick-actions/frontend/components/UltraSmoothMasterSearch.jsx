  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        onClick={onClose}
      >
        {/* Premium Backdrop - No Blur */}
        <div className="absolute inset-0 bg-gradient-to-br from-black/90 via-[#7b1c14]/20 to-black/90" />
        ...
        <motion.div
          ...
          className="relative w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden bg-gradient-to-b from-black/95 via-gray-900/90 to-black/95"
          style={{
            border: '1px solid rgba(123, 28, 20, 0.4)',
            boxShadow: '0 0 80px rgba(123, 28, 20, 0.3), 0 30px 60px rgba(0, 0, 0, 0.5)',
          }}
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-4 p-5 border-b border-white/10">
              ...
              >
                <Search className={`h-6 w-6 transition-colors duration-200 ${loading ? 'text-white/60' : 'text-white'}`} />
                {!loading && <div className="absolute inset-0 bg-white/10 blur-xl" />}
              </motion.div>
              <input
                ref={inputRef}
                type="text"
              ...
              {results.length === 0 && !loading && query.length >= 2 && (
                ...
                >
                  <div className="relative mb-6">
                    <div className="rounded-full bg-gradient-to-b from-black/95 via-gray-900/90 to-black/95 p-6 border border-white/10">
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-fuchsia-600/20 to-purple-600/20 border border-fuchsia-500/30 "
                  >
            ...
            <AnimatePresence mode="wait">
              ...
              {aiResponse && (
                ...
                >
                  ...
                  {/* AI Message */}
                  <div className="bg-gradient-to-br from-white/5 to-white/2  rounded-xl p-6 mb-4 border border-white/10">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 px-5 py-3 mb-2">
                      <motion.div
                        whileHover={{ scale: 1.05 }}
                        className={`p-2 rounded-xl bg-gradient-to-br ${config.color} ${config.glow} `}
                    ...
                    {items.map((result, idx) => {
                      ...
                      return (
                        ...
                        >
                          <button
                            onClick={() => result.locked ? null : handleSelectResult(result)}
                            className={`w-full flex items-start gap-4 px-5 py-4 transition-all duration-150 ${
                              result.locked ? 'opacity-60 cursor-not-allowed' : ''
                            } ${
                              isSelected
                          ...
                          >
                            ...
                            <div className="flex-1 text-left min-w-0">
                              ...
                              {result.locked ? (
                                <p className="text-sm text-yellow-500/90 truncate mb-1">
                                  {result.lockMessage || 'This feature is locked'}
                                </p>
                              ) : (
                                <>
                                  {result.subtitle && (
                            ...
                            >
                              {config.actions.slice(0, 3).map((action) => (
                                <motion.button
                                  ...
                                  className="px-3 py-1 text-xs bg-white/10 hover:bg-[#7b1c14]/30 text-white rounded-lg  border border-white/10 transition-colors"
                                >
                                  {action}
                                </motion.button>
                              ))}
