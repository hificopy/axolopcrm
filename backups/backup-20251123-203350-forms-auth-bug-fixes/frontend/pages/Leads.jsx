              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={7} className="text-center py-16">
                    <div className="flex flex-col items-center">
                      <Plus className="h-16 w-16 text-[#791C14]/30 mb-4" />
                      ...
                      <Button variant="default" size="default" className="gap-2 bg-[#791C14] hover:bg-[#6b1a12]" onClick={() => setIsCreateModalOpen(true)}>
                        <Plus className="h-4 w-4" />
