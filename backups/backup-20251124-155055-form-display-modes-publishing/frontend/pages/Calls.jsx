        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {canCreate() && (
            <button
              ...
              className="px-6 py-3 bg-[#791C14] text-white rounded-lg hover:bg-[#5a1410] flex items-center space-x-2 shadow-lg transform hover:scale-105 transition-all"
            >
              <Play size={20} />
        ...
        <div className="flex space-x-2 border-b border-gray-200">
          <button
            ...
            className={`px-4 py-2 font-medium transition-colors ${
              activeView === 'dialer'
                ? 'text-[#791C14] border-b-2 border-[#791C14]'
            ...
            <div>
              {currentLead ? (
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
                  ...
                  <button
                    onClick={handleGetNextCall}
                    className="px-6 py-3 bg-[#791C14] text-white rounded-lg hover:bg-[#5a1410] inline-flex items-center space-x-2"
                  >
                    <Play size={20} />
              ...
              <div className="p-4 border-b border-gray-200 bg-gray-50">
                <div className="flex space-x-3">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#791C14] focus:border-transparent"
                    value={filters.searchTerm}
                    onChange={(e) => setFilters({ ...filters, searchTerm: e.target.value })}
                  />
                  <select
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#791C14] focus:border-transparent"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <h3 className="font-semibold text-gray-900 mb-4 flex items-center">
              <Calendar size={18} className="mr-2 text-[#791C14]" />
              Today's Callbacks
            </h3>
