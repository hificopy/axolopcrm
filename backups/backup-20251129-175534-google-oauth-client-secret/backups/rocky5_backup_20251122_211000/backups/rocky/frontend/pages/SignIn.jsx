...
import { Mail, Lock, Chrome, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check if the user is Kate and redirect accordingly
      if (formData.email === 'kate@kateviolet.com') {
        // For Kate, reset the special onboarding status on login
        localStorage.removeItem('kateOnboardingCompleted');
        // Redirect Kate to onboarding to ensure she sees the special onboarding
        navigate('/onboarding');
      } else {
        navigate('/app/home');
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      {/* SEO Meta Tags */}
      <SEO
        title="Sign In to Axolop CRM - The New Age CRM with Local AI Second Brain"
        description="Sign in to your Axolop CRM account. The New Age CRM with Local AI Second Brain. All-in-one platform for sales, marketing, and automation."
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your Axolop CRM account</p>
        </div>
