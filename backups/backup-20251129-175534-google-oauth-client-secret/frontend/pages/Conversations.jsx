...
export default function Conversations() {
  ...
  const handleExport = () => {
    try {
      ...
      link.setAttribute(
        "download",
        `conversations-export-${new Date().toISOString().split("T")[0]}.csv`,
      );
      ...
      toast({
        ...
        description: `Exported ${historyEvents.length} conversation events to CSV.`,
      });
    } catch (error) {
            ...
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-gray-600">
                {searchTerm || filterType !== "ALL" || filterDateRange !== "ALL"
                  ...
                  : "Conversations will appear here as you use the CRM"}
              </p>
            </div>
          ) : (
