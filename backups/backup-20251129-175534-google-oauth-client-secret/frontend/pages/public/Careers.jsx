    ...
    <div className="min-h-screen text-white" style={{ background: '#0F0510' }}>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full blur-3xl bg-[#E92C92]/20" />
        </div>
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="w-16 h-16 rounded-2xl bg-[#E92C92]/30 flex items-center justify-center mx-auto mb-6">
              <Briefcase className="w-8 h-8 text-[#E92C92]" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {COMPANY_VALUES.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[#E92C92]/20 flex items-center justify-center mx-auto mb-4">
                    <Icon className="w-6 h-6 text-[#E92C92]" />
                  </div>
          ...
          <div className="space-y-4">
            {OPEN_POSITIONS.map((position, index) => (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-white/5 border border-gray-800/50 hover:border-[#E92C92]/50 transition-colors cursor-pointer group"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="px-2 py-0.5 rounded bg-[#E92C92]/20 text-[#E92C92] text-xs font-medium">
                        {position.department}
                      </span>
                    </div>
                    <h3 className="text-xl font-semibold text-white group-hover:text-[#E92C92] transition-colors">
                      {position.title}
                    </h3>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Link
              to="/contact"
              className="text-[#E92C92] font-medium hover:underline flex items-center justify-center gap-2"
            >
      ...
      {/* Life at Axolop */}
      <section className="py-20 bg-gradient-to-b from-black to-[#E92C92]/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="text-center mb-12"
            initial={{ opacity: 0, y: 20 }}
