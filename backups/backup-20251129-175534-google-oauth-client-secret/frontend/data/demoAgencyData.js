...
// Dashboard Metrics - Base data
const BASE_REVENUE = 31000;
const BASE_LEADS = 23;
const BASE_DEALS = 12;
const BASE_CONVERSION = 18.5;

// Helper function to generate revenue data based on time range
// CRITICAL: RevenueChart expects data with 'value' property, not 'revenue'
export const generateRevenueData = (timeRange = 'month') => {
  switch (timeRange) {
    case 'week':
      return {
        totalRevenue: 7750,
        periods: [
          { period: 'Mon', value: 950, name: 'Mon' },
          { period: 'Tue', value: 1100, name: 'Tue' },
          { period: 'Wed', value: 1250, name: 'Wed' },
          { period: 'Thu', value: 1300, name: 'Thu' },
          { period: 'Fri', value: 1450, name: 'Fri' },
          { period: 'Sat', value: 950, name: 'Sat' },
          { period: 'Sun', value: 750, name: 'Sun' },
        ],
      };
    case 'quarter':
      return {
        totalRevenue: 91000,
        periods: [
          { period: 'Month 1', value: 28000, name: 'Month 1' },
          { period: 'Month 2', value: 29500, name: 'Month 2' },
          { period: 'Month 3', value: 33500, name: 'Month 3' },
        ],
      };
    case 'year':
      return {
        totalRevenue: 350000,
        periods: [
          { period: 'Jan', value: 28000, name: 'Jan' },
          { period: 'Feb', value: 28500, name: 'Feb' },
          { period: 'Mar', value: 29000, name: 'Mar' },
          { period: 'Apr', value: 29500, name: 'Apr' },
          { period: 'May', value: 30000, name: 'May' },
          { period: 'Jun', value: 31000, name: 'Jun' },
          { period: 'Jul', value: 29500, name: 'Jul' },
          { period: 'Aug', value: 28500, name: 'Aug' },
          { period: 'Sep', value: 30000, name: 'Sep' },
          { period: 'Oct', value: 30500, name: 'Oct' },
          { period: 'Nov', value: 27000, name: 'Nov' },
          { period: 'Dec', value: 28500, name: 'Dec' },
        ],
      };
    case 'month':
    default:
      return {
        totalRevenue: 31000,
        periods: [
          { period: 'Week 1', value: 7250, name: 'Week 1' },
          { period: 'Week 2', value: 7800, name: 'Week 2' },
          { period: 'Week 3', value: 8100, name: 'Week 3' },
          { period: 'Week 4', value: 7850, name: 'Week 4' },
        ],
      };
  }
};
...
export const DEMO_DASHBOARD_METRICS = {
  sales: {
    // Revenue metrics (time-period based)
    ...
    // Sales metrics (Dashboard needs these)
    activeDeals: BASE_DEALS,
    newLeads: BASE_LEADS,
    conversionRate: BASE_CONVERSION,
    winRate: 42.3,
    avgDealSize: 12500,
    avgSalesCycle: "28 days",
    ...
    // ALL TIME METRICS (cumulative totals - not affected by time range)
    allTimeRevenue: 847500, // Total revenue since company inception
    allTimeLeads: 1247, // Total leads generated all time
    allTimeDealsWon: 156, // Total deals won all time
    allTimeConversionRate: 12.5, // Overall conversion rate all time

    // Revenue trend data (default to month)
    revenueByPeriod: generateRevenueData('month').periods,
    monthlyTrend: generateRevenueData('year').periods,
  },
  marketing: {
    // Lead metrics
    totalLeads: 50,
    ...
    // Email marketing metrics (Dashboard needs these)
    activeCampaigns: 5,
    emailOpens: 1247,
    clickRate: 3.8,
    ...
    emailsSent: 4850,
    bounceRate: 2.1,
    engagementRate: 24.5, // FullMarketingWidget needs this
    unsubscribeRate: 0.8, // FullMarketingWidget needs this
    avgOpenRate: 25.7, // FullMarketingWidget needs this
    newSubscribers: 142, // FullMarketingWidget needs this

    // EmailMarketingWidget expects these property names
    sent: 4850,
    delivered: 4748, // 97.9% delivery rate
    opened: 1247,
    clicked: 185, // ~3.8% click rate
    openRate: 26.3, // 1247/4748 * 100
  },
  profitLoss: {
    revenue: 31000,
    expenses: 18600,
  ...
  forms: {
    // FormSubmissionsWidget expects these
    total: 127,
    converted: 38,
    conversionRate: 29.9, // 38/127 * 100
    trend: [
