...
export default function MainLayout() {
  ...
  const needsAgency =
    !agenciesLoading && !agenciesLoadFailed && agencies.length === 0;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 transform-gpu relative">
        ...
        <header
          className="h-10 w-full backdrop-blur-xl border-b border-white/5 border-l-0 sticky top-0 z-50 flex items-center justify-between px-6 shadow-2xl"
          style={{
            background:
