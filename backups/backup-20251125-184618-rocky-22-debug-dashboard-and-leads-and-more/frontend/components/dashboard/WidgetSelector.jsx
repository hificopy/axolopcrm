  ...
  sales: {
    ...
    widgets: [
      ...
      },
      {
        ...
        icon: DollarSign,
        component: 'MetricCard',
        props: { title: 'Avg. Deal Size', color: 'green', subtitle: 'Per closed deal' },
      ...
      },
      {
        ...
        icon: Award,
        component: 'MetricCard',
        props: { title: 'Win Rate', color: 'green', subtitle: 'Deals won vs lost' },
      ...
      },
      {
        ...
        icon: Zap,
        component: 'MetricCard',
        props: { title: 'Sales Velocity', color: 'yellow', subtitle: 'Avg. days to close' },
      ...
      },
      {
        ...
        icon: TrendingUp,
        component: 'MetricCard',
        props: { title: 'Pipeline Value', color: 'blue', subtitle: 'Total opportunity value' },
    ...
    widgets: [
      {
        ...
        icon: Users,
        component: 'MetricCard',
        props: { title: 'New Leads', color: 'green', subtitle: 'This period' },
      ...
      },
      {
        ...
        icon: UserCheck,
        component: 'MetricCard',
        props: { title: 'Active Leads', color: 'blue', subtitle: 'In pipeline' },
      ...
      },
      {
        ...
        icon: Target,
        component: 'MetricCard',
        props: { title: 'Qualification Rate', color: 'yellow', subtitle: 'Leads qualified' },
      ...
      },
      {
        ...
        icon: Percent,
        component: 'MetricCard',
        props: { title: 'Conversion Rate', color: 'green', subtitle: 'Lead to customer' },
    ...
    widgets: [
      {
        ...
        icon: Mail,
        component: 'MetricCard',
        props: { title: 'Active Campaigns', color: 'blue', subtitle: 'Running now' },
      ...
      },
      {
        ...
        icon: Mail,
        component: 'MetricCard',
        props: { title: 'Open Rate', color: 'green', subtitle: 'Email opens' },
      ...
      },
      {
        ...
        icon: ArrowUpRight,
        component: 'MetricCard',
        props: { title: 'CTR', color: 'yellow', subtitle: 'Link clicks' },
    ...
    widgets: [
      {
        ...
        icon: Clock,
        component: 'MetricCard',
        props: { title: 'Due Today', color: 'yellow', subtitle: 'Tasks pending' },
      ...
      },
      {
        ...
        icon: Award,
        component: 'MetricCard',
        props: { title: 'Completed', color: 'green', subtitle: 'This week' },
      ...
      },
      {
        ...
        icon: Activity,
        component: 'MetricCard',
        props: { title: 'Activity', color: 'blue', subtitle: 'Recent actions' },
      ...
      },
      {
        ...
        icon: Users,
        component: 'MetricCard',
        props: { title: 'Team Score', color: 'green', subtitle: 'Productivity index' },
    ...
    widgets: [
      {
        ...
        icon: Calendar,
        component: 'MetricCard',
        props: { title: 'Upcoming', color: 'blue', subtitle: 'Scheduled meetings' },
      ...
      },
      {
        ...
        icon: Calendar,
        component: 'MetricCard',
        props: { title: 'This Week', color: 'green', subtitle: 'Meetings count' },
      ...
      },
      {
        ...
        icon: Clock,
        component: 'MetricCard',
        props: { title: 'No-Show Rate', color: 'yellow', subtitle: 'Missed meetings' },
  ...
  financial: {
    ...
    widgets: [
      ...
      },
      {
        ...
        icon: BarChart3,
        component: 'MetricCard',
        props: { title: 'Net Profit', color: 'green', subtitle: 'Revenue - Expenses' },
      ...
      },
      {
        ...
        icon: Briefcase,
        component: 'MetricCard',
        props: { title: 'Active Clients', color: 'blue', subtitle: 'Current customers' },
      ...
      },
      {
        ...
        icon: Users,
        component: 'MetricCard',
        props: { title: 'Active Accounts', color: 'green', subtitle: 'Customer base' },
                ...
                {Object.entries(WIDGET_CATEGORIES).map(([key, category]) => {
                  ...
                  return (
                    <button
                      ...
                      className={`inline-flex items-center justify-center gap-2 h-9 px-3 rounded-lg text-sm transition-colors whitespace-nowrap ${
                        selectedCategory === key
                          ? 'bg-[#761B14] text-white font-medium'
