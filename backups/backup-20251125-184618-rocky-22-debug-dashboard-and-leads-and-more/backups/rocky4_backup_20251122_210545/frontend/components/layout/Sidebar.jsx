...
export default function Sidebar() {
  ...
  return (
    <div
      className="h-screen w-48 bg-[#2c0202] dark:bg-[#2c0202] flex flex flex-col shadow-2xl border-r border-white/10"
    >
      {/* Header section with logo and text */}
      <div className="h-16 bg-transparent flex items-center px-4 rounded-br-2xl mt-0.5">
