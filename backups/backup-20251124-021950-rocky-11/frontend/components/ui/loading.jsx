      ...
      <div className="relative transform-gpu">
        ...
        <motion.div
          className={cn(
            ...
            "bg-gradient-to-r from-[#791C14] via-[#a03a2e] to-[#791C14]"
          )}
          animate={{
            rotate: 360,
            scale: [1, 1.1, 1],
...
export const Spinner = ({ size = 'default', className }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[200px] w-full">
      <motion.div
        className={cn(
          "rounded-full border-gray-200 border-t-[#791C14]",
          sizes[size],
          className
        )}
        animate={{ rotate: 360 }}
...
export const DotsLoader = ({ className }) => {
  ...
  return (
    <div className={cn("flex items-center justify-center gap-2 min-h-[200px] w-full", className)}>
      {[0, 1, 2].map((i) => (
        <motion.div
          key={i}
          className="h-3 w-3 rounded-full bg-[#791C14]"
    ...
    <div className="fixed inset-0 w-screen h-screen bg-white/80 dark:bg-[#0d0f12]/90 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <div className="w-64 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden relative">
          ...
          <motion.div
            className="absolute inset-y-0 left-0 bg-gradient-to-r from-[#791C14] via-[#a03a2e] to-[#791C14] rounded-full"
