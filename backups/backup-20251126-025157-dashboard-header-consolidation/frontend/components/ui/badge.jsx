...
function Badge({ className, variant = 'default', ...props }) {
  const variants = {
    ...
    blue: 'bg-[#761B14]/10 dark:bg-[#761B14]/20 text-[#761B14] dark:text-[#9A392D] border-[#761B14]/20 dark:border-[#761B14]/40 hover:bg-[#761B14]/15 dark:hover:bg-[#761B14]/30',
    ...
    red: 'bg-[#761B14]/10 dark:bg-[#761B14]/20 text-[#761B14] dark:text-[#9A392D] border-[#761B14]/20 dark:border-[#761B14]/40 hover:bg-[#761B14]/15 dark:hover:bg-[#761B14]/30',
    ...
    danger: 'bg-[#761B14]/10 dark:bg-[#761B14]/20 text-[#761B14] dark:text-[#9A392D] border-[#761B14]/20 dark:border-[#761B14]/40 hover:bg-[#761B14]/15 dark:hover:bg-[#761B14]/30',
    info: 'bg-[#761B14]/10 dark:bg-[#761B14]/20 text-[#761B14] dark:text-[#9A392D] border-[#761B14]/20 dark:border-[#761B14]/40 hover:bg-[#761B14]/15 dark:hover:bg-[#761B14]/30',
  };
