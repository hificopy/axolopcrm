...
export default function EmailMarketingWidget({ data }) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: opened,
      icon: Eye,
      color: 'text-[#9A392D] dark:text-[#d4463c]',
      bgColor: 'bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-700/50'
    },
    {
      label: 'Clicked',
      value: clicked,
      icon: MousePointer,
      color: 'text-[#B85450] dark:text-[#d4463c]',
      bgColor: 'bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-700/50'
    }
  ];
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#761B14] to-[#9A392D]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#9A392D] to-[#B85450]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#B85450] to-[#761B14]"
                />
              </div>
            </div>
          </div>
