      ...
      <div className="flex items-center gap-2 mb-4 pb-4 border-b border-gray-200 flex-wrap">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button className="bg-gradient-to-r from-[#761B14] to-[#9A392D] hover:from-[#8B2318] hover:to-[#A84A3F] text-white font-semibold px-4 py-2 rounded-lg flex items-center gap-2 shadow-sm transition-all">
              {newItemLabel}
            ...
            <div className="space-y-3">
              ...
              {Object.keys(activeFilters).length > 0 && (
                <button
                  ...
                  className="text-sm text-[#761B14] hover:underline"
                >
                  Clear all filters
                </button>
              )}
            ...
            <div className="space-y-2">
              ...
              {columns.map((col) => (
                <button
                  ...
                  className={cn(
                    ...
                    sortColumn === col.key && 'bg-[#761B14]/10 text-[#761B14]'
                  )}
                >
                  <span>{col.label}</span>
                  {sortColumn === col.key && (
              ...
              {sortColumn && (
                <button
                  ...
                  className="w-full text-sm text-[#761B14] hover:underline text-left px-3 py-1"
                >
                  Clear sort
                </button>
              )}
            ...
            <div className="space-y-2">
              ...
              {hiddenColumns.size > 0 && (
                <button
                  ...
                  className="text-sm text-[#761B14] hover:underline w-full text-left px-2 pt-2"
                >
                  Show all
                </button>
              )}
          ...
          <Popover>
            ...
            <PopoverContent className="w-56 p-3" align="start">
              <div className="space-y-2">
                ...
                <button className="w-full text-left px-3 py-2 text-sm bg-[#761B14]/10 text-[#761B14] rounded-md">
                  Current grouping ✓
                </button>
