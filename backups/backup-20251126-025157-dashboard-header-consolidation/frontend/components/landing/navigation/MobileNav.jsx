          ...
          >
            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-6">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    'bg-gradient-to-r from-[#4A1515]/40 via-[#3D1212]/40 to-[#4A1515]/30',
                    'border border-[#4A1515]/40',
                    'hover:border-[#d4463c]/50',
                ...
                >
                  ...
                  <div className="flex items-center gap-1 text-[#d4463c]">
              ...
              <div className="space-y-3 pt-4 border-t border-gray-800/50">
                <Button
                  className={cn(
                    'w-full bg-gradient-to-br from-[#4A1515] to-[#3D1212]',
