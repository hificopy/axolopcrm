    ...
    >
      ...
      >
        ...
        <CardContent className="p-6 h-full flex flex-col justify-center relative z-10">
          {/* Icon Badge - Top right inside card */}
          <motion.div
            className={`absolute top-2 right-2 w-8 h-8 sm:w-10 sm:h-10 rounded-lg ${colors.bg} flex items-center justify-center flex-shrink-0 shadow-lg`}
