...
import { Settings, Download, Save, Sparkles, LayoutGrid, DollarSign, Users, TrendingUp, Percent, X, FileText, File, Lock, Unlock, ArrowLeftRight, ArrowUpDown, Calendar as CalendarIcon, Grid3X3, Info, MoreVertical } from 'lucide-react';
            ...
            <div className="absolute top-6 right-4 sm:top-6 sm:right-6">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  {/* Time Range Section */}
                  <DropdownMenuLabel className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Time Range</DropdownMenuLabel>
                  <DropdownMenuItem onClick={() => setTimeRange('week')} className={timeRange === 'week' ? 'bg-[#761B14]/10' : ''}>
                    <CalendarIcon className="h-4 w-4 mr-2" />
                    This Week
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setTimeRange('month')} className={timeRange === 'month' ? 'bg-[#761B14]/10' : ''}>
                    <CalendarIcon className="h-4 w-4 mr-2" />
                    This Month
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setTimeRange('quarter')} className={timeRange === 'quarter' ? 'bg-[#761B14]/10' : ''}>
                    <CalendarIcon className="h-4 w-4 mr-2" />
                    This Quarter
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setTimeRange('year')} className={timeRange === 'year' ? 'bg-[#761B14]/10' : ''}>
                    <CalendarIcon className="h-4 w-4 mr-2" />
                    This Year
                  </DropdownMenuItem>
                  ...
                  <DropdownMenuLabel className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Dashboard Presets</DropdownMenuLabel>
                  {presetList.map((preset) => (
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-600 ml-6">{preset.description}</span>
                    </DropdownMenuItem>
                  ))}
                  {customPresets.length > 0 && (
                    <>
                      <DropdownMenuLabel className="text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">My Custom Presets</DropdownMenuLabel>
                  ...
                  {canEdit() && (
                    <>
                      <DropdownMenuLabel className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Layout</DropdownMenuLabel>
                      {isEditMode ? (
                        <>
                          <DropdownMenuItem onClick={() => setShowWidgetSelector(true)}>
                  ...
                  <DropdownMenuItem onClick={handleExportHTML}>
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-600">Interactive web document</span>
                    </div>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={handleExportPDF}>
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-600">Print-ready document</span>
                    </div>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
                  ...
                  <div className="drag-handle absolute -top-1 left-0 right-0 h-8 bg-[#761B14] rounded-t-xl cursor-move flex items-center justify-between px-3 z-20 shadow-lg hover:bg-[#6b1a12] transition-all duration-300">
                    ...
                    <div className="flex items-center gap-0.5">
                      ...
                      <button
                        ...
                        className="text-white hover:text-[#9A392D] transition-all duration-200 p-1 rounded hover:bg-white/20 ml-0.5"
