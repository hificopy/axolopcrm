...
const colorStyles = {
  red: { iconBg: 'bg-[#761B14]/20', iconText: 'text-[#d4463c]' },
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#761B14]/10 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#761B14] to-[#d4463c]">
                For Agency Owners
              </span>
            </h1>
            ...
            >
              <div className="aspect-video rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-800/50 flex items-center justify-center">
                <div className="text-center">
                  <Lightbulb className="w-16 h-16 text-[#d4463c] mx-auto mb-4" />
