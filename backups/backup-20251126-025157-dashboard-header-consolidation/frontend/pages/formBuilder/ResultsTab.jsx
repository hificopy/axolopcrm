          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-[#761B14]/10 rounded-lg">
                  <Eye className="h-6 w-6 text-[#761B14]" />
                </div>
              </div>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <div className="flex items-center gap-1 mt-2 text-xs">
                ...
                <span className="text-[#761B14]">{stats.disqualifiedLeads} disqualified</span>
              </div>
            </CardContent>
          </Card>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg ${
                      ...
                      submission.status === 'disqualified' ? 'bg-[#761B14]/10' :
                      'bg-gray-100'
                    }`}>
                      {submission.status === 'qualified' ? (
                        <CheckCircle2 className="h-5 w-5 text-green-600" />
                      ) : submission.status === 'disqualified' ? (
                        <XCircle className="h-5 w-5 text-[#761B14]" />
                      ) : (
