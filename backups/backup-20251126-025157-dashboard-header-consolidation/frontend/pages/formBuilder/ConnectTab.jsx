...
export default function ConnectTab({ form }) { // Removed setForm as it's no longer needed for integrations
  ...
  if (error) {
    return <div className="h-full min-h-screen flex items-center justify-center text-[#761B14] pt-[150px]">Error loading integrations: ${error.message}</div>;
  }
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#761B14]/10 rounded-lg">
                  <Mail className="h-5 w-5 text-[#761B14]" />
                </div>
                <div>
