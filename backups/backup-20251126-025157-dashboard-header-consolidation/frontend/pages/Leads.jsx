    ...
    <div className="h-full flex flex-col crm-page-wrapper bg-white">
      ...
      <div className="relative bg-white border-b border-gray-200 px-4 sm:px-6 py-6">
        ...
        <div className="crm-stats-grid mt-6">
          ...
          <div className="bg-gradient-to-br from-[#761B14]/5 to-[#761B14]/10 rounded-xl p-5 border border-[#761B14]/30 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <a
                      ...
                      className="text-[#761B14] hover:underline"
                    >
                      {selectedLead.website}
                    </a>
                  </div>
