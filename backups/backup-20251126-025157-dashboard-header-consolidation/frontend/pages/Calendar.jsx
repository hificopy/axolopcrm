...
export default function Calendar() {
  ...
  const handleCreateBookingLink = useCallback(async (data) => {
    try {
  ...
  const handleSaveEditedBookingLink = useCallback(async (data) => {
    try {
  ...
  const copyBookingLink = useCallback(async (slug) => {
    try {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-gray-50 via-white to-gray-50">
                ...
                {canCreate() && (
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="flex items-center gap-2 bg-gradient-to-r from-[#761B14] to-[#9A392D] text-white px-5 py-2.5 rounded-xl hover:shadow-lg transition-all font-semibold shadow-md hover:scale-105">
      ...
      {activeMode === "calendar" && !isGoogleConnected && (
        <div className="bg-gradient-to-r from-[#761B14]/5 via-[#761B14]/10 to-[#9A392D]/5 border-b border-[#761B14]/20 px-6 py-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-[#761B14] to-[#9A392D] flex items-center justify-center shadow-lg animate-pulse">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-[#761B14] to-[#9A392D] text-white px-6 py-3 rounded-xl hover:shadow-2xl transition-all font-bold hover:scale-105 shadow-lg"
            >
