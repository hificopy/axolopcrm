          ...
          {supabaseUser?.email === 'axolopcrm@gmail.com' && isDemoMode && (
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className="text-xs py-1.5 px-3 border-[#761B14]/20 text-[#761B14] hover:bg-[#761B14]/5 hover:border-[#761B14]/30"
              >
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-[#1a1d24] rounded-lg border border-crm-border p-6 mb-6">
            {uploadError && (
              <div className="mb-4 p-3 bg-[#761B14]/5 border border-[#761B14]/20 text-[#761B14] rounded-lg text-sm">
                {uploadError}
              </div>
            )}
