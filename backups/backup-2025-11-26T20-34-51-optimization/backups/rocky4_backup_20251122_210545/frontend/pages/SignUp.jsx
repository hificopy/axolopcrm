...
import { Mail, Lock, User, Chrome, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
...
const SignUp = () => {
  ...
  const [fromOnboarding, setFromOnboarding] = useState(!!onboardingData.fromOnboarding);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userMetadata = {
        ...
        recommended_plan: onboardingData.recommendedPlan || localStorage.getItem('recommended_plan'),
      };
      ...
      if (affiliateRef && result.user) {
        try {
          ...
          console.log('✅ Affiliate referral tracked in Supabase:', response.data);
        } catch (affiliateErr) {
        ...
        <div className="w-full max-w-md">
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl shadow-2xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-4">
              Your account has been created for <strong className="text-white">{formData.email}</strong>
            </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      {/* SEO Meta Tags */}
      <SEO
        title="Sign Up for Axolop CRM - The New Age CRM with Local AI Second Brain"
        description="Sign up for Axolop CRM. The New Age CRM with Local AI Second Brain. All-in-one platform for sales, marketing, and automation. Free forever plan available."
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Join Axolop CRM and streamline your workflow</p>
        </div>
