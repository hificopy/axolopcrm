...
const sessionLimiter = createSessionLimiter(isDev ? 200 : 50, 15 * 60 * 1000); // 200 req/15min in dev, 50 in prod
const globalLimiter = createGlobalLimiter(isDev ? 100 : 20, 15 * 60 * 1000); // 100 req/15min in dev, 20 in prod
...
app.use("/api/users", usersRoutes); // Critical for user management
