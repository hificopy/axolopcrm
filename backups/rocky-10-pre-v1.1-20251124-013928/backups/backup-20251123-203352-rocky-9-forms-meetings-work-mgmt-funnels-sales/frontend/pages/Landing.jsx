    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="relative group">
                {/* Subtle Accent Glow */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#791C14]/0 via-[#791C14]/20 to-[#791C14]/0 blur-2xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Button
                ...
                className="relative overflow-hidden bg-gradient-to-br from-[#791C14]/40 via-[#791C14]/30 to-[#791C14]/20 hover:from-[#791C14]/60 hover:via-[#791C14]/50 hover:to-[#791C14]/40 text-white border-2 border-[#791C14]/60 shadow-lg backdrop-blur-xl transition-all duration-300"
              >
      ...
      {affiliateName && (
        <motion.div
          ...
          className="fixed top-16 left-0 right-0 z-40 bg-gradient-to-r from-[#791C14] via-[#8b2214] to-[#791C14] border-b-2 border-[#ff6b4a]/30 shadow-2xl backdrop-blur-xl"
        >
      ...
      <section ref={heroRef} className={`${affiliateName ? 'pt-48' : 'pt-28'} pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden relative`}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#791C14]/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#791C14]/5 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <motion.div
              ...
              className="mb-6"
            >
              <Badge className="relative overflow-hidden bg-gradient-to-r from-[#791C14]/40 via-[#791C14]/30 to-[#791C14]/20 text-white border-2 border-[#791C14]/60 backdrop-blur-xl px-4 py-2 text-sm font-bold shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-black/20 pointer-events-none" />
            ...
            <div className="hero-cta flex flex-col sm:flex-row items-center justify-center gap-4 mb-6" style={{ opacity: 1 }}>
              <Button
                size="lg"
                onClick={handleGetStarted}
                className="relative overflow-hidden bg-gradient-to-br from-[#791C14]/40 via-[#791C14]/30 to-[#791C14]/20 hover:from-[#791C14]/60 hover:via-[#791C14]/50 hover:to-[#791C14]/40 text-white text-lg px-10 py-7 rounded-xl border-2 border-[#791C14]/60 shadow-2xl backdrop-blur-xl transition-all duration-300 transform hover:scale-105"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-black/20 pointer-events-none" />
              ...
              <Button
                size="lg"
                variant="outline"
                className="relative overflow-hidden text-white border-2 border-gray-700/50 hover:border-[#791C14]/60 bg-white/5 hover:bg-[#791C14]/10 text-lg px-10 py-7 rounded-xl backdrop-blur-xl transition-all duration-300"
              >
          ...
          <div className="hero-dashboard relative max-w-6xl mx-auto" style={{ willChange: 'transform, opacity' }}>
            {/* Glow Effect */}
            <div className="absolute -inset-4 bg-gradient-to-r from-[#791C14]/20 via-[#a03a2e]/20 to-[#791C14]/20 rounded-3xl blur-2xl"></div>
                ...
                <div className="w-52 bg-gradient-to-br from-[hsl(var(--crm-sidebar-gradient-start))] via-[hsl(var(--crm-sidebar-gradient-mid))] to-[hsl(var(--crm-sidebar-gradient-end))] border-r border-gray-800/30 flex flex-col">
                  ...
                  <div className="px-3 py-4 border-b border-gray-800/30">
                    <div className="flex items-center justify-between gap-2 mb-3">
                      {/* CRM - Active */}
                      <button className="relative flex flex-col items-center justify-center flex-1 h-16 rounded-xl backdrop-blur-xl bg-gradient-to-br from-[#791C14]/40 via-[#791C14]/30 to-[#791C14]/20 border-2 border-[#791C14]/60 shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-black/20 pointer-events-none" />
                        ...
                        <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-[#791C14] rounded-full" />
                      </button>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      <button className="flex items-center justify-center py-2 px-2 rounded-lg bg-gradient-to-r from-[#791C14]/30 via-[#791C14]/20 to-transparent text-white border border-[#791C14] text-xs font-medium">
                  ...
                  <div className="p-6 overflow-y-auto h-[calc(100%-4rem)]">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-6">
                      ...
                      <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="text-4xl font-bold text-[#791C14] mb-2">$125k</div>
                      ...
                      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 rounded-xl bg-[#791C14] flex items-center justify-center">
                              <DollarSign className="h-5 w-5 text-white" />
                            </div>
                            <div>
                        ...
                        <div className="h-32 bg-gradient-to-br from-red-50 to-rose-50 rounded-lg flex items-end px-4 pb-4">
                          <div className="flex-1 h-full flex items-end justify-around">
                            <div className="w-8 bg-gradient-to-t from-[#791C14] to-[#a03a2e] rounded-t" style={{ height: '60%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#791C14] to-[#a03a2e] rounded-t" style={{ height: '75%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#791C14] to-[#a03a2e] rounded-t" style={{ height: '65%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#791C14] to-[#a03a2e] rounded-t" style={{ height: '85%' }}></div>
                            <div className="w-8 bg-gradient-to-t from-[#791C14] to-[#a03a2e] rounded-t" style={{ height: '90%' }}></div>
                          </div>
                        </div>
                        <div className="grid grid-cols-3 gap-4 mt-4 text-xs">
                          ...
                          <div className="text-center">
                            ...
                            <div className="font-bold text-[#791C14]">$95,000</div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-16 gap-y-10">
            {['Wayfair', 'Deloitte', 'Pfizer', 'Adobe', 'American Airlines', 'NBC Universal'].map((company, i) => (
              <motion.div
                ...
                className="text-2xl font-bold text-gray-600 hover:text-[#791C14] transition-all duration-300 cursor-pointer"
              >
                {company}
              </motion.div>
            ))}
      ...
      <section className="py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            >
              <div className="px-4 py-2 rounded-full bg-gradient-to-r from-[#791C14]/20 via-[#d4463c]/20 to-[#791C14]/20 border border-[#791C14]/40">
                <span className="text-sm font-semibold bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14] bg-clip-text text-transparent">
                  THE NEW AGE OF CRMS
                </span>
              </div>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <motion.div
              ...
              className="group relative overflow-hidden bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm rounded-3xl p-10 border-2 border-gray-800/50 hover:border-[#791C14]/60 transition-all duration-500 hover:shadow-[0_20px_70px_-10px_rgba(212,70,60,0.5)]"
            >
              {/* Brand color glow */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#791C14]/20 dark:bg-[#d4463c]/20 blur-3xl rounded-full" />
              </div>

              <div className="relative z-10">
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#791C14] to-[#d4463c] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 shadow-2xl shadow-[#791C14]/50">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-gray-400 group-hover:text-white transition-colors">
                      <div className="w-2 h-2 rounded-full bg-[#791C14] mt-2 flex-shrink-0 group-hover:shadow-lg group-hover:shadow-[#791C14]/50 transition-shadow" />
          ...
          >
            <Button
              size="lg"
              onClick={handleGetStarted}
              className="relative overflow-hidden bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14] text-white text-lg px-12 py-8 rounded-2xl border-2 border-[#791C14] shadow-2xl transition-all duration-300 transform hover:scale-105 group"
            >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <motion.div
              ...
              className="inline-block mb-5"
            >
              <div className="px-4 py-2 rounded-full bg-gradient-to-r from-[#791C14]/10 via-[#d4463c]/10 to-[#791C14]/10 border border-[#791C14]/20">
                <span className="text-sm font-semibold bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14] bg-clip-text text-transparent">
                  100+ FEATURES
                </span>
              </div>
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14] bg-clip-text text-transparent">
                converged workspace
              </span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-16">
            {Object.entries(FEATURE_ICONS).map(([feature, Icon], i) => (
              <motion.div
                ...
                className="group relative overflow-hidden bg-gray-900/50 rounded-2xl p-5 border border-gray-800/50 hover:border-[#791C14]/50 hover:bg-gray-900/80 transition-all duration-300 cursor-pointer hover:shadow-lg hover:shadow-[#791C14]/20"
              >
                <div className="relative z-10">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#791C14]/20 to-[#d4463c]/20 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                    <Icon className="h-5 w-5 text-[#d4463c] group-hover:text-[#791C14] transition-colors" />
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 animate-on-scroll">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="group relative overflow-hidden bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm rounded-3xl p-10 border-2 border-gray-800/50 hover:border-[#791C14]/60 transition-all duration-500 hover:shadow-[0_20px_70px_-10px_rgba(123,28,20,0.4)]"
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#d4463c]/20 blur-3xl rounded-full" />
              </div>
              <div className="relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#791C14] to-[#d4463c] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#791C14]/30">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            >
              <Badge className="relative overflow-hidden bg-[#791C14]/20 text-white border border-[#791C14]/40 backdrop-blur-xl px-6 py-3 text-sm font-bold shadow-lg hover:bg-[#791C14]/30 transition-all">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#791C14]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-[#791C14]/30 to-[#d4463c]/30 backdrop-blur-sm rounded-xl p-5 border-2 border-[#d4463c]/40 flex items-center justify-between font-bold text-xl shadow-lg mt-4">
            ...
            <div className="text-center">
              ...
              >
                {/* Subtle Shine Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#791C14]/10 via-transparent to-[#14787b]/5 opacity-50"></div>

                <div className="relative z-10">
                  <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#791C14] to-[#d4463c] rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 hover:rotate-3 transition-transform duration-300">
                    <img
                      src="/axolop-logo.png"
                      alt="Axolop"
                  ...
                  <div className="mb-2">
                    <span className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14]">$149</span>
                  ...
                  <Button
                    onClick={handleGetStarted}
                    className="w-full bg-gradient-to-r from-[#791C14] to-[#d4463c] hover:from-[#d4463c] hover:to-[#791C14] text-white text-base py-6 rounded-xl shadow-lg transform hover:scale-105 transition-all font-semibold"
                  >
                    Start Free Forever
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-[#791C14] to-[#d4463c] rounded-2xl flex items-center justify-center shadow-lg border-2 border-[#d4463c]/40">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14]">
                AI Agents
              </span>
            </h2>
              ...
              {[
                {
                  ...
                  gradient: 'from-[#791C14] to-[#d4463c]',
                  color: '#791C14'
                },
                {
                  icon: Zap,
            ...
            <Button
              size="lg"
              onClick={handleGetStarted}
              className="mt-12 bg-gradient-to-r from-[#791C14] via-[#d4463c] to-[#791C14] hover:from-[#d4463c] hover:via-[#791C14] hover:to-[#d4463c] text-white text-base px-10 py-6 rounded-xl shadow-lg transform hover:scale-105 transition-all font-semibold"
            >
              Try AI Agents Free
      ...
      <section id="comparison" className="py-32 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            >
              <Badge className="bg-[#791C14]/20 text-white border border-[#d4463c]/40 px-6 py-3 text-sm font-bold">
                Feature Comparison
              </Badge>
            </motion.div>
                ...
                <tr>
                  ...
                  <th className="px-6 py-5 text-center">
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#791C14] to-[#d4463c] flex items-center justify-center shadow-md">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button
                size="lg"
                onClick={handleGetStarted}
                className="bg-gradient-to-r from-[#791C14] to-[#a03a2e] hover:from-[#a03a2e] hover:to-[#791C14] text-white text-xl px-12 py-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all"
              >
                {affiliateRef
          ...
          <div className="grid md:grid-cols-5 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-[#791C14] transition-colors">
                  <Star className="h-6 w-6" />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li><a href="#" className="hover:text-[#791C14] transition-colors">Help Center</a></li>
                <li><a href="#" className="hover:text-[#791C14] transition-colors">Contact Us</a></li>
                <li><a href="#" className="hover:text-[#791C14] transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-[#791C14] transition-colors">Terms of Service</a></li>
              </ul>
            </div>
          </div>
