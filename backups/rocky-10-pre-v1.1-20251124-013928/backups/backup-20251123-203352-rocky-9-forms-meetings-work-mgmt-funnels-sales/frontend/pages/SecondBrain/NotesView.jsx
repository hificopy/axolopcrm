      ...
      <div className="relative h-screen w-screen flex flex-col bg-gray-50 dark:bg-gray-900 p-0 m-0">
        ...
        {!selectedNote && (
          <button
            ...
            className="absolute top-4 right-4 z-10 flex items-center gap-2 px-4 py-2 bg-[#791C14] hover:bg-[#651610] text-white rounded-lg transition-colors shadow-lg"
          >
              ...
              <div className="flex-1 w-full overflow-y-auto p-8 bg-gray-50 dark:bg-gray-900">
                {loading ? (
                  <div className="flex items-center justify-center h-64">
                    <FileText className="w-12 h-12 text-[#791C14] animate-pulse" />
                  </div>
                ) : notes.length === 0 ? (
                  ...
                  <div className="max-w-7xl mx-auto">
                    <div className="grid gap-3">
                      {notes.map(note => (
                        ...
                        >
                          <FileText className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-[#791C14] transition-colors" />
