...
// OrganizationSettings deprecated - use AgencySettings instead
...
function App() {
  // Get supabase context (it has built-in error handling)
    ...
    <ErrorBoundary>
      <div className="app">
        <Routes location={location}>
          ...
          <Route path="/features/automation" element={<FeatureAutomation />} />
          ...
          <Route path="/features/meetings-ai" element={<FeatureMeetingsAI />} />

          {/* Feature Pages - Automation */}
          <Route path="/features/workflows" element={<FeatureWorkflows />} />
          <Route path="/features/sequences" element={<FeatureSequences />} />
          ...
          <Route path="/app" element={<MainLayout />}>
            ...
            >
              ...
              <Route
                path="organization/*"
                element={<Navigate to="/app/settings/agency/general" replace />}
              />
