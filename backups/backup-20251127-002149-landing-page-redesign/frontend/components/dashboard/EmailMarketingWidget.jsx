...
export default function EmailMarketingWidget({ data }) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: opened,
      icon: Eye,
      color: 'text-[#5C2222] dark:text-[#761B14]',
      bgColor: 'bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-700/50'
    },
    {
      label: 'Clicked',
      value: clicked,
      icon: MousePointer,
      color: 'text-[#CA4238] dark:text-[#761B14]',
      bgColor: 'bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-700/50'
    }
  ];
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#761B14] to-[#5C2222]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#5C2222] to-[#CA4238]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 dark:bg-gray-800/50 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#CA4238] to-[#761B14]"
                />
              </div>
            </div>
          </div>
