    ...
    <div className="text-center max-w-md w-full">
      ...
      <div className="mt-8">
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div className="bg-gradient-to-r from-[#761B14] to-[#8B2B1F] h-2 rounded-full animate-pulse" style={{ width: '70%' }}></div>
        </div>
...
export const ProgressBar = ({ progress = 0, stage = "Processing...", showPercentage = true }) => (
  <div className="w-full bg-white p-4 rounded-lg shadow-lg border border-gray-200">
    ...
    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
      <div
        className="bg-gradient-to-r from-[#761B14] to-[#8B2B1F] h-3 rounded-full transition-all duration-500 ease-out relative"
