...
const StatCard = React.forwardRef(({
  ...
  const colorVariants = {
    ...
    accent: {
      bg: 'bg-[#4A1515]/10 dark:bg-[#4A1515]/20',
      text: 'text-[#4A1515] dark:text-gray-300',
      border: 'border-[#4A1515]/20 dark:border-[#4A1515]/40',
      hover: 'group-hover:bg-[#4A1515]/15 dark:group-hover:bg-[#4A1515]/30'
    },
    gray: {
    ...
    >
      ...
      <div className="flex items-baseline justify-between">
        <div className={cn(
          ...
          color === 'accent' && "group-hover:text-[#4A1515]"
        )}>
          {value}
        </div>
