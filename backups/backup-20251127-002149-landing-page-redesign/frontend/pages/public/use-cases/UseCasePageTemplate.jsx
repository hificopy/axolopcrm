              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#761B14] to-[#761B14] flex items-center justify-center text-white font-bold">
                ...
                <thead>
                  <tr className="border-b border-gray-800">
                    ...
                    <th className="py-4 px-4 text-center">
                      <span className="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-[#761B14] to-[#761B14] text-white text-sm font-bold">
                        Axolop
                      </span>
                    </th>
