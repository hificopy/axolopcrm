...
export default function Opportunities() {
  ...
  const calculateStats = () => {
    ...
    const totalDeals = opportunities.filter(
      (opp) => opp.status !== "CANCELLED",
    ).length;
    const winRate =
              ...
              {loading ? (
                ...
                filteredOpportunities.map((opp) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant={getStageColor(opp.stage)}
                    ...
                    <TableCell>
                      <Badge
                        variant={getStatusColor(opp.status)}
                        className="font-medium"
                      >
                        {opp.status || "OPEN"}
                      </Badge>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {selectedOpportunity.owner?.name || "Unassigned"}
                    </span>
                  </div>
                </div>
              </div>
