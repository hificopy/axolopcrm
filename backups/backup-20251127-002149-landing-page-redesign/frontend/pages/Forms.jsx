        ...
        <div className="text-center max-w-md w-full">
          ...
          <div className="mt-8">
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="bg-gradient-to-r from-[#761B14] to-[#3D1515] h-2 rounded-full animate-pulse"
                style={{ width: "70%" }}
              ></div>
            </div>
                  ...
                  {canEdit() && (
                    ...
                    >
                      <Button
                        variant="outline"
                        size="sm"
                        className="min-w-[40px] flex-1 sm:flex-none border-[#761B14]/30 text-[#761B14] hover:border-[#761B14] hover:bg-[#761B14]/5"
