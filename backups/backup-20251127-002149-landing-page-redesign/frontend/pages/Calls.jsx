...
const Calls = () => {
  ...
  const getDispositionColor = (disposition) => {
    const colors = {
      ...
      not_interested: 'bg-[#761B14]/10 text-[#761B14]',
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div key={item.id} className="p-4 hover:bg-gray-50 cursor-pointer">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          {item.priority > 0 && (
                            <span className="inline-block mt-1 px-2 py-1 bg-[#761B14]/10 text-[#761B14] text-xs rounded">
                              Priority
                            </span>
                          )}
                        </div>
        ...
        <div className="space-y-6">
          ...
          {currentScript && (
            <div className="bg-gradient-to-br from-[#761B14]/5 to-[#3D1515]/10 rounded-lg border border-[#761B14]/20 p-4">
              <h3 className="font-semibold text-gray-900 mb-2 flex items-center">
                <span className="w-2 h-2 bg-[#761B14] rounded-full mr-2" />
                Active Script
              </h3>
