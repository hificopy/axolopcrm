        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                At Axolop, we are committed to protecting the privacy and personal data of our users.
                We comply with the General Data Protection Regulation (GDPR), the comprehensive data
                protection law in the European Union.
              </p>
              <p>
                This page outlines how we handle personal data in accordance with GDPR requirements
                and explains your rights as a data subject.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Axolop acts as the Data Controller for the personal data we collect and process.
                This means we determine the purposes and means of processing personal data.
              </p>
              <div className="bg-gray-50 rounded-lg p-4">
                <p><strong>Data Controller:</strong> Axolop</p>
                <p><strong>Contact Email:</strong> <a href="mailto:hello@axolop.com" className="text-blue-600 hover:underline">hello@axolop.com</a></p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>Contract:</strong> When processing is necessary to fulfill a contract with you or to take steps at your request before entering into a contract.</li>
                <li><strong>Legal Obligation:</strong> When processing is necessary to comply with legal requirements.</li>
                <li><strong>Legitimate Interest:</strong> When we have a legitimate business interest that does not override your fundamental rights and freedoms.</li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4 mt-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p>You have the right to request access to your personal data and to receive a copy of the data we hold about you.</p>
                </div>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-gray-900">Right to Erasure ("Right to be Forgotten")</h3>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p>You have the right to object to the processing of your personal data based on legitimate interests or for direct marketing purposes.</p>
                </div>

                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-gray-900">Right to Withdraw Consent</h3>
                  <p>Where we rely on consent for processing, you have the right to withdraw that consent at any time.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                ...
                it was collected, including satisfying legal, accounting, or reporting requirements.
              </p>
              <p>
                When determining retention periods, we consider the amount, nature, and sensitivity of
                the data, the potential risk of harm from unauthorized use or disclosure, and applicable
                legal requirements.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                ...
                <p className="mt-2">
                  Please include "GDPR Request" in your subject line and provide sufficient information
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                If you believe that we have not complied with your data protection rights, you have
                the right to lodge a complaint with a supervisory authority. You may do so in the
                EU member state of your habitual residence, place of work, or the place of the
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                We may update this GDPR compliance page from time to time. Any changes will be
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              If you have any questions about GDPR or our data protection practices, please contact us at:<br />
              <strong>Email:</strong> <a href="mailto:hello@axolop.com" className="text-blue-600 hover:underline">hello@axolop.com</a>
            </p>
          </section>
        </div>
