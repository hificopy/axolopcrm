...
export const THEME_PRESETS = {
  default: {
    id: "default",
    name: "Default",
    description: "Axolop signature dark burgundy theme",
    isRemovable: false, // Cannot be deleted - this is the main branding
    colors: {
      // HSL values matching current CSS variables
      gradientStart: "0 56% 10%", // Deep dark burgundy
      gradientMid: "0 0% 6%", // Main black #101010
      gradientEnd: "0 45% 12%", // Warm dark accent
      hover: "0 50% 18%", // Warm hover with burgundy undertones
      active: "0 56% 18%", // Dark burgundy #4A1515
      accent: "#4A1515", // Primary accent color (hex for indicators)
    },
  },
  ocean: {
    id: "ocean",
