import { CheckSquare, ListTodo, Calendar, Users, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative bg-white border-b border-gray-200 px-4 sm:px-6 py-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Organize and track your tasks</p>
          </div>
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-8 text-center shadow-sm">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Task Management</h2>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Create and manage task lists with advanced features like dependencies and collaboration. Coming soon.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <ListTodo className="h-6 w-6 text-blue-500 mb-2" />
                <span className="text-sm font-medium text-gray-700">Personal Tasks</span>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <Users className="h-6 w-6 text-green-500 mb-2" />
                <span className="text-sm font-medium text-gray-700">Team Tasks</span>
              </div>
            </div>
          </div>
        </div>
