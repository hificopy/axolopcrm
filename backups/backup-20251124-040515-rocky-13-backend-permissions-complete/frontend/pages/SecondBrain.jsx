    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative inline-block mb-8">
            <div className="relative">
              <Brain className="w-24 h-24 text-[#791C14] mx-auto" />

              {/* Orbiting particles */}
              <div className="absolute inset-0 -m-8">
                <div className="absolute w-3 h-3 bg-[#791C14] rounded-full animate-orbit-1"
                     style={{ top: '50%', left: '50%', transformOrigin: '0 0' }} />
                <div className="absolute w-3 h-3 bg-[#791C14]/70 rounded-full animate-orbit-2"
                     style={{ top: '50%', left: '50%', transformOrigin: '0 0' }} />
                <div className="absolute w-3 h-3 bg-[#791C14]/40 rounded-full animate-orbit-3"
                     style={{ top: '50%', left: '50%', transformOrigin: '0 0' }} />
              </div>
            </div>
          </div>
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#791C14]/10 text-[#791C14] mb-6">
          ...
          <div className="flex gap-4 justify-center mb-16">
            <button className="px-8 py-3 rounded-lg bg-[#791C14] text-white font-semibold hover:bg-[#651610] transition-colors shadow-lg hover:shadow-xl">
              Join Waitlist
            </button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Feature 1 */}
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <FileText className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
          ...
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <Link2 className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
          ...
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <Network className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              Knowledge Graph
            </h3>
          ...
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <Search className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              AI-Powered Search
            </h3>
          ...
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <Zap className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              Databases & Views
            </h3>
          ...
          <div className="group p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-[#791C14] hover:-translate-y-1">
            <div className="w-12 h-12 rounded-lg bg-[#791C14]/10 flex items-center justify-center mb-4 group-hover:bg-[#791C14] transition-colors">
              <Sparkles className="w-6 h-6 text-[#791C14] group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              AI Assistant
            </h3>
        ...
        {/* Why Second Brain */}
        <div className="max-w-4xl mx-auto mt-20 p-8 rounded-2xl bg-gradient-to-br from-[#791C14]/10 to-[#791C14]/5 border border-[#791C14]/20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="w-8 h-8 rounded-full bg-[#791C14] text-white flex items-center justify-center flex-shrink-0 font-bold">
                1
              </div>
              <div>
          ...
          <div className="space-y-6">
            <div className="flex gap-6">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[#791C14] text-white flex items-center justify-center font-bold">
                  Q2
                </div>
                <div className="w-0.5 h-full bg-[#791C14]/30 mt-2"></div>
              </div>
              <div className="pb-8">
            ...
            <div className="flex gap-6">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[#791C14]/50 text-white flex items-center justify-center font-bold">
                  Q3
                </div>
                <div className="w-0.5 h-full bg-[#791C14]/30 mt-2"></div>
              </div>
            ...
            <div className="flex gap-6">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[#791C14]/30 text-white flex items-center justify-center font-bold">
                  Q4
                </div>
              </div>
              <div>
        ...
        <div className="max-w-3xl mx-auto mt-20 text-center">
          ...
          <div className="flex gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#791C14]"
            />
            <button className="px-8 py-3 rounded-lg bg-[#791C14] text-white font-semibold hover:bg-[#651610] transition-colors shadow-lg hover:shadow-xl">
              Join
            </button>
