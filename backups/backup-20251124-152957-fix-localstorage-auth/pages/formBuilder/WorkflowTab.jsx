      ...
      <div className="flex-1 relative bg-gray-50 dark:bg-[#0d0f12]">
        ...
        >
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-3 pb-2 border-b border-crm-border">Start Screens</h4>
              <div className="grid grid-cols-3 gap-2">
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => configureStartScreen('welcome')}>
                  <Play className="w-4 h-4 mr-2 text-green-600" />
                  Welcome
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => configureStartScreen('video')}>
                  <Video className="w-4 h-4 mr-2 text-green-600" />
                  Video Intro
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => configureStartScreen('image')}>
            ...
            <div>
              <h4 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-3 pb-2 border-b border-crm-border">Question Types</h4>
              <div className="grid grid-cols-3 gap-3">
                {/* Text Inputs */}
                <div className="space-y-2">
                  <h5 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-2">Text Input</h5>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addQuestionWithConnection('text', window.__quickAddSourceNodeId)}>
                    <Type className="w-4 h-4 mr-2 text-blue-600" />
                    Short Text
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addQuestionWithConnection('textarea', window.__quickAddSourceNodeId)}>
                    <FileText className="w-4 h-4 mr-2 text-blue-600" />
                    Long Text
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addQuestionWithConnection('email', window.__quickAddSourceNodeId)}>
                    <Mail className="w-4 h-4 mr-2 text-blue-600" />
                    Email
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addQuestionWithConnection('tel', window.__quickAddSourceNodeId)}>
                    <Phone className="w-4 h-4 mr-2 text-blue-600" />
                    Phone
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addQuestionWithConnection('number', window.__quickAddSourceNodeId)}>
                ...
                {/* Selection */}
                <div className="space-y-2">
                  <h5 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-2">Selection</h5>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-purple-50" onClick={() => addQuestionWithConnection('select', window.__quickAddSourceNodeId)}>
                    <List className="w-4 h-4 mr-2 text-purple-600" />
                    Dropdown
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-purple-50" onClick={() => addQuestionWithConnection('radio', window.__quickAddSourceNodeId)}>
                    <CheckCircle2 className="w-4 h-4 mr-2 text-purple-600" />
                    Radio Buttons
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-purple-50" onClick={() => addQuestionWithConnection('checkbox', window.__quickAddSourceNodeId)}>
                    <CheckSquare className="w-4 h-4 mr-2 text-purple-600" />
                    Checkboxes
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-purple-50" onClick={() => addQuestionWithConnection('toggle', window.__quickAddSourceNodeId)}>
                ...
                {/* Special */}
                <div className="space-y-2">
                  <h5 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-2">Special</h5>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => addQuestionWithConnection('date', window.__quickAddSourceNodeId)}>
                    <Calendar className="w-4 h-4 mr-2 text-green-600" />
                    Date
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => addQuestionWithConnection('time', window.__quickAddSourceNodeId)}>
                    <Calendar className="w-4 h-4 mr-2 text-green-600" />
                    Time
                  </Button>
                  <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => addQuestionWithConnection('rating', window.__quickAddSourceNodeId)}>
            ...
            {/* End Screens Section */}
            <div>
              <h4 className="text-xs font-semibold text-crm-text-secondary uppercase tracking-wider mb-3 pb-2 border-b border-crm-border">End Screens</h4>
              <div className="grid grid-cols-4 gap-2">
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-gray-50" onClick={() => addEnding('neutral')}>
                  <MessageSquare className="w-4 h-4 mr-2 text-gray-600" />
                  Thank You
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-green-50" onClick={() => addEnding('qualified')}>
                  <ThumbsUp className="w-4 h-4 mr-2 text-green-600" />
                  Qualified
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-red-50" onClick={() => addEnding('disqualified')}>
                  <ThumbsDown className="w-4 h-4 mr-2 text-red-600" />
                  Disqualified
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-blue-50" onClick={() => addEnding('redirect')}>
                  <ExternalLink className="w-4 h-4 mr-2 text-blue-600" />
                  Redirect
                </Button>
                <Button variant="outline" className="w-full justify-start text-sm h-10 hover:bg-purple-50" onClick={() => addEnding('contact')}>
