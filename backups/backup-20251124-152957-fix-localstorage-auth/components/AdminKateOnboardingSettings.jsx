  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#791C14]"></div>
      </div>
    );
  }
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <div className="flex items-center space-x-3 mb-6">
          <input
            ...
            className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#791C14] focus:border-transparent"
          />
          <button
            onClick={handleAddMessage}
            className="bg-[#791C14] hover:bg-[#8b2c24] text-white px-4 py-2 rounded-lg transition-colors"
          >
            Add
          </button>
        </div>
        ...
        <button
          onClick={handleSave}
          className="bg-[#791C14] hover:bg-[#8b2c24] text-white px-6 py-3 rounded-lg font-medium transition-colors"
        >
          Save Changes
        </button>
