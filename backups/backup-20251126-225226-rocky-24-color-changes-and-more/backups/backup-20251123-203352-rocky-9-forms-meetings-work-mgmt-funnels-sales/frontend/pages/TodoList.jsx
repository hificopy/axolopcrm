      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex gap-3">
          <Input
            ...
            className="flex-1 border-gray-300 focus:ring-[#791C14] focus:border-[#791C14]"
          />
          <Button
            onClick={addTodo}
            className="bg-[#791C14] hover:bg-[#6b1a12] shadow-lg gap-2"
          >
        ...
        {filteredTodos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl border border-gray-200 shadow-lg">
            <div className="p-6 rounded-full bg-[#791C14]/10 mx-auto mb-6">
              <CheckSquare className="h-16 w-16 text-[#791C14]" />
            </div>
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 w-6 h-6 rounded-md border-2 flex items-center justify-center transition-all ${
                      todo.completed
                        ...
                        : 'border-gray-300 hover:border-[#791C14]'
                    }`}
                  >
                    ...
                    {editingId === todo.id ? (
                      ...
                      <>
                        <Button
                          ...
                          className="hover:border-[#791C14] hover:text-[#791C14]"
                        >
