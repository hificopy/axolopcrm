...
const CONFIG = {
  ...
  SUPABASE_URL:
    process.env.SUPABASE_URL || "https://fkjupzwgadgdcueexaxq.supabase.co",
  SUPABASE_ANON_KEY:
    process.env.SUPABASE_ANON_KEY ||
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZranVwendnYWRnZGN1ZWV4YXhxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQxMDAzMjksImV4cCI6MjA0OTY3NjMyOX0.vvJELJE8A5x2mWqpc1qJpqeNp2gJ9tWr3XKiwzN273E",
  TEST_USER: {
    email: "test@axolopcrm.com",
