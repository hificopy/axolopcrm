...
const sessionLimiter = createSessionLimiter(50, 15 * 60 * 1000); // 50 requests per 15 min per session
const globalLimiter = createGlobalLimiter(20, 15 * 60 * 1000); // 20 requests per 15 min for unauthenticated
