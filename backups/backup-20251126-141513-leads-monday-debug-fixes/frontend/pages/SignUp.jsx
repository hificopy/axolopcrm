    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Join Axolop and streamline your workflow</p>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl shadow-2xl p-8">
          ...
          {error && (
            <div className="mb-6 p-4 bg-[#761B14]/10 border border-[#761B14]/50 rounded-lg flex items-start gap-3">
              ...
              <p className="text-sm text-[#9A392D]">{error}</p>
            </div>
          )}
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">
            ...
            <Link to="/terms" className="text-gray-400 hover:text-gray-300 underline" target="_blank" rel="noopener noreferrer">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link to="/privacy-policy" className="text-gray-400 hover:text-gray-300 underline" target="_blank" rel="noopener noreferrer">
              Privacy Policy
            </Link>
          </p>
        </div>
