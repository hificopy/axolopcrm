                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2 text-sm text-crm-text-secondary">
                          ...
                          {selectedQuestion.required && <span className="text-[#761B14]">*</span>}
                        </div>
                      </div>
                          ...
                          <div className="flex items-start gap-3 mb-3">
                            ...
                            <div className="flex-1">
                              <h2 className="text-base font-semibold text-crm-text-primary">
                                {question.title}
                                {question.required && <span className="text-[#761B14] ml-1">*</span>}
                              </h2>
                            </div>
                          </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        {hasConditionalLogic && (
                          <GitBranch className="h-3 w-3 text-[#761B14]" title="Has conditional logic" />
                        )}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-crm-text-secondary">
                          ...
                          {question.required && <span className="text-[#761B14]"> *</span>}
                        </div>
                      </div>
                      <Button
                        variant="ghost"
