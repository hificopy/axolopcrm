            ...
            <>
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-600 dark:text-gray-400 hover:text-[#761B14] dark:hover:text-[#9A392D]"
                  title="Delete (Del)"
                >
