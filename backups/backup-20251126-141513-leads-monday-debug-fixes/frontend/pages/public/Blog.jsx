                ...
                <div className="relative rounded-2xl overflow-hidden bg-gray-900 border border-gray-800/50 hover:border-gray-700/50 transition-colors">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-4 mb-3">
                      <span className="px-3 py-1 rounded-full bg-[#761B14]/20 text-[#d4463c] text-xs font-medium">
                        {post.category}
                      </span>
                    ...
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#d4463c] transition-colors">
                      {post.title}
                    </h3>
                    <p className="text-gray-400 text-sm mb-4">{post.excerpt}</p>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#761B14] to-[#d4463c] flex items-center justify-center text-white text-xs font-bold">
                      ...
                      <ArrowRight className="w-5 h-5 text-gray-500 group-hover:text-[#d4463c] group-hover:translate-x-1 transition-all" />
                    </div>
                  </div>
                </div>
              </motion.article>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="relative w-full md:w-auto">
              ...
              <input
                ...
                className="w-full md:w-64 pl-10 pr-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-[#761B14]"
              />
            </div>
          </div>
        </div>
              ...
              >
                <div className="rounded-2xl overflow-hidden bg-gray-900 border border-gray-800/50 hover:border-gray-700/50 transition-colors h-full flex flex-col">
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <h3 className="text-lg font-bold text-white mb-2 group-hover:text-[#d4463c] transition-colors flex-1">
                      {post.title}
                    </h3>
      ...
      <section className="py-20 bg-gradient-to-b from-black to-[#761B14]/20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Mail className="w-12 h-12 text-[#d4463c] mx-auto mb-4" />
            ...
            <form className="flex flex-col sm:flex-row gap-4 justify-center">
              <input
                ...
                className="px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-[#761B14] w-full sm:w-80"
              />
              <button
                type="submit"
                className={cn(
