        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="w-16 h-16 rounded-2xl bg-[#761B14]/30 flex items-center justify-center mx-auto mb-6">
              <Puzzle className="w-8 h-8 text-[#d4463c]" />
            </div>
              ...
              return (
                ...
                >
                  ...
                  {integration.status === 'available' && (
                    <button className="text-[#d4463c] text-sm font-medium hover:underline flex items-center gap-1">
      ...
      <section className="py-20 bg-gradient-to-b from-black to-[#761B14]/20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Plus className="w-12 h-12 text-[#d4463c] mx-auto mb-4" />
