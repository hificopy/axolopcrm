...
const COLORS = {
  leads: "#B85450", // Soft red - top of funnel
  qualified: "#9A392D", // Medium red - middle
          ...
          {isEmpty ? (
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-3 mt-4">
                ...
                >
                  <div className="text-xs text-[#B85450] font-medium">
                    Leads
                  </div>
                ...
                <motion.div
                  ...
                  className="bg-neutral-50 dark:bg-neutral-900/20 rounded-lg p-2 text-center border border-neutral-200/50 dark:border-neutral-700/50 hover:shadow-md transition-shadow"
                >
                  <div className="text-xs text-[#9A392D] font-medium">
                    Qualified
                  </div>
                  <div className="text-lg font-bold text-crm-text-primary">
                    {qualified}
