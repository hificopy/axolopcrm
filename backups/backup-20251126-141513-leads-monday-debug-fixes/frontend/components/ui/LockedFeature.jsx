...
import { getFeatureDetails, getFeatureVersion, isFeatureLocked } from '@/config/features';
...
export const LockedOverlay = ({
  ...
  const displayDesc = description || details?.description || 'This feature is currently under development.';
  ...
  return (
    <div className={`flex flex-col items-center justify-center py-16 ${className}`}>
      ...
      <h2 className="text-2xl font-semibold text-crm-text-primary mb-2">{displayTitle}</h2>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 max-w-md">
        <p className="text-sm text-blue-800 dark:text-blue-200 text-center">
          <span className="font-semibold">Coming in {version}:</span> This feature will be available soon!
          <Link
            to="/roadmap"
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-crm-text-primary">{details.name}</h3>
            <LockedBadge version={details.version} />
          </div>
          <p className="text-sm text-crm-text-secondary mt-1">{details.description}</p>
        </div>
