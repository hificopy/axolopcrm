  ...
  return (
    <>
      <motion.nav
        ...
        style={{
          background: "linear-gradient(180deg, #0a0e18 0%, #0F1522 100%)",
        }}
        className={cn(
          ...
          <div className="flex items-center h-16">
            ...
            <Link to="/" className="flex items-center gap-3 group flex-shrink-0">
              ...
              >
                ...
                <div className="absolute inset-0 rounded-lg bg-[#4F1B1B]/50 blur-xl opacity-0 group-hover:opacity-50 transition-opacity" />
              </motion.div>
            ...
            <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
              <Button
                variant="ghost"
                className="text-base text-gray-300 hover:text-white hover:bg-white/5"
        ...
        <AnimatePresence>
          {affiliateName && (
            <motion.div
              ...
              className="overflow-hidden bg-gradient-to-r from-[#4F1B1B] via-[#5C2222] to-[#4F1B1B]"
            >
