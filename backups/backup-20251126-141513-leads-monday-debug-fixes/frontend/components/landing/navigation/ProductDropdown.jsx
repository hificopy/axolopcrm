...
const colorStyles = {
  red: {
    iconBg: 'bg-[#4F1B1B]/20',
    iconText: 'text-[#6A2525]',
    hoverBg: 'hover:bg-[#4F1B1B]/10',
  },
  teal: {
    iconBg: 'bg-[#14787b]/20',
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{
              background: "linear-gradient(180deg, #0F1522 0%, #131a2a 40%, #0F1522 100%)",
            }}
            className={cn(
              ...
              <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-3">
                  ...
                  <div className="space-y-3">
                    {[
                      { name: 'Insurance Agencies', desc: 'Compliance & renewals', href: '/use-cases/insurance', icon: Shield },
                      { name: 'Call Centers', desc: 'Dialer & analytics', href: '/use-cases/call-centers', icon: Phone },
                      { name: 'Marketing Agencies', desc: 'Replace 10+ tools', href: '/use-cases/marketing-agencies', icon: Users },
                      { name: 'Real Estate', desc: 'Lead & deal management', href: '/use-cases/real-estate', icon: Home },
                      { name: 'B2B Sales', desc: 'Pipeline automation', href: '/use-cases/b2b-sales', icon: Briefcase },
                      { name: 'Consulting Firms', desc: 'Client management', href: '/use-cases/consulting', icon: GraduationCap },
                    ].map((useCase) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-sm font-medium text-white">{useCase.name}</p>
