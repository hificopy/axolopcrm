  ...
  return (
    <div className="flex h-screen w-full bg-[hsl(var(--crm-sidebar-gradient-start))] overflow-hidden transition-colors duration-300 ease-out">
      ...
      <div className="flex-1 flex flex-col min-w-0 transform-gpu relative">
        ...
        <header className="h-10 w-full bg-gradient-to-r from-black/95 via-gray-900/90 to-gray-800/90 backdrop-blur-xl border-b border-white/5 border-l-0 sticky top-0 z-10 flex items-center justify-between px-6 shadow-2xl">
