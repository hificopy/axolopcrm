                ...
                {filteredWidgets.map((widget) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group border border-crm-border rounded-lg p-4 hover:border-[#7b1c14] hover:shadow-md transition-all cursor-pointer"
                      onClick={() => handleAddWidget(widget)}
                    >
                      <div className="flex items-start gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center group-hover:from-[#7b1c14]/10 group-hover:to-[#7b1c14]/20 transition-colors">
                          <Icon className="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-[#7b1c14] dark:group-hover:text-[#d4463c]" />
                        </div>
                        <div className="flex-1">
                          <h3 className="font-medium text-sm text-crm-text-primary group-hover:text-[#7b1c14] transition-colors">
                            {widget.name}
                          </h3>
