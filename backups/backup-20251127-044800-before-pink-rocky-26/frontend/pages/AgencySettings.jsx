    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin text-[#761B14] mx-auto mb-4" />
    ...
    return (
      <div className="p-8 text-center">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#761B14] hover:bg-[#8B2B1F] text-white rounded-lg transition-colors"
        >
          Go to Dashboard
        </button>
      </div>
    ...
    <>
      <div className="p-8">
        ...
        {activeTab === "branding" && (
          <div className="space-y-6">
            {/* Header */}
            <div className="bg-gradient-to-r from-[#761B14]/10 to-yellow-500/10 border border-[#761B14]/30 rounded-lg p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-[#761B14]/20 ring-2 ring-[#761B14]/30">
                  <Palette className="h-6 w-6 text-[#761B14]" />
                </div>
                <div>
                  ...
                  return (
                    <button
                      ...
                      className={`relative p-4 rounded-xl border-2 transition-all duration-200 text-left group ${
                        isSelected
                          ? "border-[#761B14] bg-[#761B14]/10 ring-2 ring-[#761B14]/30"
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        {isSelected && (
                          <div className="p-1 rounded-full bg-[#761B14]">
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                      ...
                      (currentAgency?.settings?.theme || "default")
                        ...
                        : "bg-gradient-to-r from-[#761B14] to-[#8B2B1F] hover:from-[#8B2B1F] hover:to-[#3D1515] text-white shadow-lg hover:shadow-[#761B14]/30"
                    }`}
                  >
                    {savingTheme ? (
                      <>
