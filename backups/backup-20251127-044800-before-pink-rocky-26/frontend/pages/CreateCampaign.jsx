      ...
      <div className="flex items-center gap-4">
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-full ${
            step === 1 ? 'bg-[#761B14]/10 text-[#761B14]' : 'bg-gray-100 text-gray-500'
          }`}
          onClick={() => setStep(1)}
        >
        ...
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-full ${
            step === 2 ? 'bg-[#761B14]/10 text-[#761B14]' : 'bg-gray-100 text-gray-500'
          }`}
          onClick={() => setStep(2)}
        >
        ...
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-full ${
            step === 3 ? 'bg-[#761B14]/10 text-[#761B14]' : 'bg-gray-100 text-gray-500'
          }`}
          onClick={() => setStep(3)}
        >
        ...
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-full ${
            step === 4 ? 'bg-[#761B14]/10 text-[#761B14]' : 'bg-gray-100 text-gray-500'
          }`}
          onClick={() => setStep(4)}
        >
