        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            ...
            {feature.marketingHighlight && (
              <div className="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-[#4F1B1B] to-[#3D1515] rounded-full">
    ...
    <div className="mb-6">
      <button
        ...
        className={`w-full flex items-center justify-between p-5 rounded-xl border transition-all duration-300 ${
          isThisWeek()
            ? "bg-gradient-to-r from-[#4F1B1B]/10 to-[#3D1515]/20 border-[#6A2525]/30 shadow-lg backdrop-blur-xl"
            : isPastWeek()
        ...
        <div className="flex items-center gap-4">
          <div
            className={`p-3 rounded-xl ${
              isThisWeek()
                ? "bg-gradient-to-br from-[#4F1B1B] to-[#3D1515]"
                : isPastWeek()
                  ? "bg-green-900/30"
                  : "bg-blue-900/30"
            }`}
          ...
          <div className="text-left">
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              Week {weekNumber}
              {isThisWeek() && (
                <span className="px-2 py-1 bg-gradient-to-r from-[#4F1B1B] to-[#3D1515] text-white text-xs font-bold rounded-full">
                  THIS WEEK
                </span>
              )}
            </h2>
  ...
  return (
    <div className="relative min-h-screen bg-[#000000] text-white">
              ...
              <div key={version} className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border border-gray-700/50">
                <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                  <div className={`p-2 rounded-lg ${
                    ...
                    version === 'V1.1' ? 'bg-[#4F1B1B]/20' :
                    'bg-blue-900/30'
                  }`}>
                    {version === 'V1.0' ? (
                      <Check className="h-5 w-5 text-green-400" />
                    ) : version === 'V1.1' ? (
                      <Rocket className="h-5 w-5 text-[#4F1B1B]" />
                    ) : (
            ...
            {Object.entries(featuresByCategory).map(([category, features]) => (
              ...
              >
                <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                  <Zap className="h-5 w-5 text-[#4F1B1B]" />
                  {category}
                </h3>
                <div className="space-y-3">
                  {features.map((feature) => (
      ...
      {marketingHighlights.length > 0 && (
        <section className="bg-gradient-to-br from-[#4F1B1B] to-[#3D1515] py-16">
