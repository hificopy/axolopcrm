        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 lg:space-x-8">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-[#761B14] rounded-lg flex items-center justify-center">
            ...
            <nav className="hidden lg:flex space-x-6">
              <a href="#" className="text-[#761B14] font-medium">
                Dashboard
              </a>
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            <div className="relative hidden lg:block">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#761B14]"
              />
            </div>
