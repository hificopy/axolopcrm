        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-gradient-to-br from-[#761B14]/20 to-[#8B2B1F]/20 ring-1 ring-[#761B14]/30">
                <UserPlus className="h-5 w-5 text-[#761B14]" />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-800/50 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#761B14]/50 focus:border-[#761B14]/50 transition-all pr-24"
                  disabled={loading}
                />
                <button
                  onClick={handleValidate}
                  disabled={validating || loading || !inviteUrl.trim()}
                  className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-md bg-[#761B14]/20 hover:bg-[#761B14]/30 text-[#761B14] text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {validating ? (
              ...
              <div className="p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-xl">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      You'll join as:{" "}
                      <span className="text-[#761B14] font-medium capitalize">
                        {agencyPreview.role}
                      </span>
                    </p>
                  </div>
          ...
          <div className="flex gap-3 p-6 pt-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 rounded-lg bg-gradient-to-r from-[#761B14] to-[#8B2B1F] hover:from-[#8B2B1F] hover:to-[#a13328] text-white font-bold transition-all shadow-lg hover:shadow-[#761B14]/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
