  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-white/10 rounded-2xl w-full max-w-md mx-4 shadow-2xl overflow-hidden">
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#761B14]/5 via-transparent to-[#8B2B1F]/5 pointer-events-none"></div>
        ...
        <form onSubmit={handleSubmit} className="relative z-10 p-6 space-y-5">
          {error && (
            <div className="p-4 bg-[#761B14]/10 border border-[#761B14]/30 rounded-xl text-[#8B2B2B] text-sm flex items-start gap-3">
              <div className="p-1 bg-[#761B14]/20 rounded">
