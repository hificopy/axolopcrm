        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-[#761B14] to-[#5C2222] px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#5C2222]/80 text-sm">Error ID: {this.state.errorId}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  {canRetry && (
                    <Button
                      ...
                      className="w-full gap-2 bg-[#761B14] hover:bg-[#5C2222]"
                      size="lg"
                    >
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <a 
                  ...
                  className="text-[#761B14] hover:text-[#5C2222] underline"
                  target="_blank"
