...
class EnhancedDashboardDataService {
  ...
  async getAllMetrics(timeRange = "month", include = "all") {
    ...
    try {
      console.log(
        `🚀 [METRICS] Loading dashboard with unified API (timeRange: ${timeRange}, include: ${include})`,
      );
      ...
      console.log(
        `✅ [METRICS] Dashboard loaded from ${result.source} in ${responseTime}ms`,
      );
      ...
      console.log("⚠️ [METRICS] Falling back to legacy dashboard service");
