          ...
          <div className="text-center mb-16">
            ...
            >
              <div className="px-4 py-2 rounded-full bg-gradient-to-r from-[#761B14]/20 via-[#5C2222]/20 to-[#761B14]/20 border border-[#761B14]/40">
                <span className="text-sm font-semibold bg-gradient-to-r from-[#761B14] via-[#5C2222] to-[#761B14] bg-clip-text text-transparent">
                  THE NEW AGE OF CRMS
                </span>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#761B14] via-[#5C2222] to-[#761B14] bg-clip-text text-transparent">
                converged workspace
              </span>
            </h2>
            ...
            <div className="text-center">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#761B14] via-[#5C2222] to-[#761B14]">
                      One Platform
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CA4238] via-[#14787b] to-amber-500">
                AI-Powered Automation
              </span>
            </h2>
