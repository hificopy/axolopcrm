          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Email us at <a href="mailto:privacy@axolop.com" className="text-blue-600 hover:underline">privacy@axolop.com</a></li>
              </ul>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 border-l-4 border-gray-500 p-4 mt-4">
                <p className="text-gray-700">
                  ...
                  rights by emailing <a href="mailto:privacy@axolop.com" className="text-blue-600 hover:underline">privacy@axolop.com</a> or
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                available at: <a href="https://edpb.europa.eu/about-edpb/about-edpb/members_en" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://edpb.europa.eu/about-edpb/about-edpb/members_en</a>
              </p>

              <h3 className="text-lg font-semibold text-gray-900 mt-4">For UK Residents</h3>
              <p>
                You may contact the Information Commissioner's Office (ICO) at: <a href="https://ico.org.uk" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://ico.org.uk</a>
              </p>
              ...
              <p>
                ...
                Attorney General at: <a href="https://oag.ca.gov/privacy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://oag.ca.gov/privacy</a>
              </p>
