          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mt-4">
                ...
                <p>Email: <a href="mailto:privacy@axolop.com" className="text-blue-600 hover:underline">privacy@axolop.com</a></p>
                <p>General inquiries: <a href="mailto:hello@axolop.com" className="text-blue-600 hover:underline">hello@axolop.com</a></p>
              </div>
            </div>
          </section>
