  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-gray-50 via-white to-gray-50">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-[#761B14] to-[#3D1515] flex items-center justify-center shadow-lg">
              ...
              <div className="flex items-center gap-2 bg-gray-100 rounded-xl p-1.5 w-fit shadow-inner">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 ${
                    activeMode === "calendar"
                      ? "bg-gradient-to-r from-[#761B14] to-[#3D1515] text-white shadow-lg scale-105"
                ...
                {canCreate() && (
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="flex items-center gap-2 bg-gradient-to-r from-[#761B14] to-[#3D1515] text-white px-5 py-2.5 rounded-xl hover:shadow-lg transition-all font-semibold shadow-md hover:scale-105">
      ...
      {activeMode === "calendar" && !isGoogleConnected && (
        <div className="bg-gradient-to-r from-[#761B14]/5 via-[#761B14]/10 to-[#3D1515]/5 border-b border-[#761B14]/20 px-6 py-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-[#761B14] to-[#3D1515] flex items-center justify-center shadow-lg animate-pulse">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-[#761B14]/10 text-[#761B14] text-xs font-semibold">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-[#761B14] to-[#3D1515] text-white px-6 py-3 rounded-xl hover:shadow-2xl transition-all font-bold hover:scale-105 shadow-lg"
            >
            ...
            <div className="h-full bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              <style>{`
                ...
                .fc {
                  ...
                  --fc-button-hover-bg-color: #3D1515;
                  --fc-button-hover-border-color: #3D1515;
                ...
                .fc .fc-button-primary {
                  background: linear-gradient(to right, #761B14, #3D1515);
                  border: none;
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-semibold text-[#761B14]">
                  {getDropOffRate()}%
                </span>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-[#761B14]/5 rounded-lg">
                <div className="flex items-center gap-3">
                  <XCircle className="h-8 w-8 text-[#761B14]" />
                  <div>
                    <p className="font-semibold text-[#4A1515]">Lost Deals</p>
                    <p className="text-xs text-[#761B14]">Did not convert</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-2xl font-bold text-[#761B14]">
                    {salesAnalytics?.outcomes.lost || 0}
                  </p>
                  <p className="text-xs text-[#761B14]">
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-[#761B14]">
          ...
          bookingLinks.map((link) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Trash2 className="h-3 w-3 text-[#761B14]" />
                </Button>
              </div>
            </motion.div>
          ))
