    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-6">
          ...
          <div className="bg-gradient-to-br from-[#761B14]/5 to-[#761B14]/10 rounded-xl p-4 border border-[#761B14]/20 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex items-center gap-2">
              <div className="p-1.5 rounded-lg bg-[#761B14]/10">
                <AlertTriangle className="h-4 w-4 text-[#761B14]" />
              </div>
              <div>
                <div className="text-[10px] font-semibold text-[#761B14] uppercase tracking-wide">
                  High Priority
                </div>
                <div className="text-xl font-bold text-[#761B14]">
                  {stats.highPriority}
                </div>
              </div>
            </div>
