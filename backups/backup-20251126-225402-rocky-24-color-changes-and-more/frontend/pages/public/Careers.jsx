        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="w-16 h-16 rounded-2xl bg-[#761B14]/30 flex items-center justify-center mx-auto mb-6">
              <Briefcase className="w-8 h-8 text-[#761B14]" />
            </div>
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[#761B14]/20 flex items-center justify-center mx-auto mb-4">
                    <Icon className="w-6 h-6 text-[#761B14]" />
                  </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="px-2 py-0.5 rounded bg-[#761B14]/20 text-[#761B14] text-xs font-medium">
                        {position.department}
                      </span>
                    </div>
                    <h3 className="text-xl font-semibold text-white group-hover:text-[#761B14] transition-colors">
                      {position.title}
                    </h3>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Link
              to="/contact"
              className="text-[#761B14] font-medium hover:underline flex items-center justify-center gap-2"
            >
