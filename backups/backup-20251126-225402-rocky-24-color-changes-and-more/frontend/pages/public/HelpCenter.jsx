    ...
    <div className="min-h-screen bg-black text-white">
                ...
                >
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#761B14]/20 flex items-center justify-center flex-shrink-0">
                      <CategoryIcon className="w-5 h-5 text-[#761B14]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-medium text-white group-hover:text-[#761B14] transition-colors">
                        {category.title}
                      </h3>
                      <p className="text-sm text-gray-500">{category.articles} articles</p>
                    </div>
                    <ChevronRight className="w-5 h-5 text-gray-600 group-hover:text-[#761B14] transition-colors" />
                  </Link>
                </motion.div>
              );
            })}
          ...
          <div className="space-y-2">
            {POPULAR_ARTICLES.map((article, index) => (
              ...
              >
                ...
                >
                  <div>
                    <h3 className="text-white group-hover:text-[#761B14] transition-colors">
                      {article.title}
                    </h3>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <MessageSquare className="w-12 h-12 text-[#761B14] mx-auto mb-4" />
