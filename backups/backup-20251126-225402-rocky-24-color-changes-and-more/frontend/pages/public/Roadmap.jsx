...
const getFeatureStatus = (feature) => {
  ...
  if (daysUntil <= 7) {
    return {
      ...
      color: "red",
      bgColor: "bg-[#4A1515]/10 dark:bg-[#4A1515]/30",
      textColor: "text-[#761B14] dark:text-[#761B14]",
      borderColor: "border-[#4A1515]/30 dark:border-[#4A1515]/50",
    };
  }
...
const CountdownTimer = ({ nextFeature }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#761B14] to-[#3D1515] rounded-xl p-6 text-white shadow-[0_0_40px_rgba(79,27,27,0.6),_inset_0_1px_0_rgba(255,255,255,0.1)]">
...
const FeatureCard = ({ feature, showWeek = false }) => {
  ...
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-gray-800 border ${status.borderColor} rounded-xl p-5 hover:shadow-lg transition-all duration-300 group cursor-pointer`}
    >
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              {feature.tagline && (
                <p className="text-sm text-[#4F1B1B] font-medium mt-1">
                  {feature.tagline}
                </p>
              )}
            </div>
            {feature.marketingHighlight && (
              <div className="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-[#4A1515] to-[#3D1212] rounded-full">
    ...
    <div className="mb-6">
      <button
        ...
        className={`w-full flex items-center justify-between p-5 rounded-xl border transition-all duration-300 ${
          isThisWeek()
            ? "bg-gradient-to-r from-[#4A1515]/5 to-[#3D1212]/10 border-[#4A1515]/30 shadow-lg"
            : isPastWeek()
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              Week {weekNumber}
              {isThisWeek() && (
                <span className="px-2 py-1 bg-gradient-to-r from-[#4A1515] to-[#3D1212] text-white text-xs font-bold rounded-full">
                  THIS WEEK
                </span>
              )}
            </h2>
  ...
  return (
    <div className="relative min-h-screen bg-[#000000] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 bg-gradient-to-br from-[#761B14] to-[#3D1515] rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform shadow-lg">
            ...
            <Link
              to="/signin"
              className="px-6 py-2.5 bg-gradient-to-br from-[#761B14] to-[#3D1515] hover:from-[#5C2222] hover:to-[#761B14] text-white font-semibold rounded-xl transition-all duration-300 shadow-[0_0_40px_rgba(79,27,27,0.6),_inset_0_1px_0_rgba(255,255,255,0.1)] transform hover:scale-105 hover:shadow-[0_0_50px_rgba(79,27,27,0.7)]"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="p-3 bg-gradient-to-br from-[#761B14] to-[#3D1515] rounded-2xl">
                <Rocket className="h-8 w-8 text-white" />
              </div>
              <div className="px-4 py-2 bg-gradient-to-r from-[#761B14]/20 to-[#3D1515]/20 rounded-full border border-[#6A2525]/30">
                <span className="text-[#761B14] font-bold text-sm">
                  WEEKLY ROLLOUTS
                </span>
              </div>
            </div>
            ...
            >
              ...
              <span className="block text-3xl md:text-4xl text-[#761B14] mt-2">
                Every Single Week
              </span>
            </h1>
            ...
            <div className="flex items-center justify-center gap-8 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-[#761B14] shadow-lg"></div>
                <span className="text-sm font-medium text-gray-300">
                  This Week
                </span>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {thisWeekFeatures.length > 0 && (
              <div className="bg-gradient-to-br from-[#761B14]/10 to-[#3D1515]/20 rounded-xl p-6 border border-[#6A2525]/30 backdrop-blur-xl">
                <div className="flex items-center gap-3 mb-4">
                  <Flame className="h-6 w-6 text-[#761B14]" />
            ...
            {nextWeekFeatures.length > 0 && (
              <div className="bg-gradient-to-br from-blue-900/20 to-indigo-900/20 rounded-xl p-6 border border-blue-800/50 backdrop-blur-xl">
                <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 bg-white/5 backdrop-blur-xl rounded-xl p-1 border border-gray-700/50">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                viewMode === "weekly"
                  ? "bg-gradient-to-r from-[#761B14] to-[#3D1515] text-white shadow-md"
                  ...
                  <div
                    className={`p-2 rounded-lg ${
                      version === "V1.0"
                        ? "bg-green-100 dark:bg-green-900/30"
                        : version === "V1.1"
                          ? "bg-[#4A1515]/10 dark:bg-[#4A1515]/30"
                          : "bg-blue-100 dark:bg-blue-900/30"
                    }`}
                  >
                    {version === "V1.0" ? (
                      ...
                      <Rocket className="h-5 w-5 text-[#761B14] dark:text-[#761B14]" />
                    ) : (
            ...
            {Object.entries(featuresByCategory).map(([category, features]) => (
              ...
              >
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <Zap className="h-5 w-5 text-[#761B14] dark:text-[#761B14]" />
                  {category}
                </h3>
                <div className="space-y-3">
                  {features.map((feature) => (
      ...
      {marketingHighlights.length > 0 && (
        <section className="bg-gradient-to-br from-[#4A1515] to-[#3D1212] py-16">
      ...
      <section className="bg-gray-50 dark:bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <Gift className="h-8 w-8 text-[#761B14] dark:text-[#761B14]" />
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-br from-[#4A1515] to-[#3D1212] hover:from-[#5C1E1E] hover:to-[#4A1515] text-white font-bold rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(74,21,21,0.3)] hover:shadow-[0_0_30px_rgba(74,21,21,0.4)] text-lg"
              >
                Start Free Trial
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-[#4A1515] to-[#3D1212] rounded-xl flex items-center justify-center">
                  <span className="text-white font-bold text-lg">A</span>
                </div>
