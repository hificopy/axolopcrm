          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Submit requests to <a href="mailto:support@axolop.com" className="text-blue-600 hover:underline">support@axolop.com</a></li>
              ...
              <div className="overflow-x-auto mt-4">
                <table className="min-w-full border border-gray-200 text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-gray-50">
                      <td className="px-4 py-3 font-semibold text-blue-600">Low (P4)</td>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="mt-4">
                ...
                <Link to="/status" className="text-blue-600 hover:underline">axolop.com/status</Link>
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mt-4">
                <p><strong>Email:</strong> <a href="mailto:support@axolop.com" className="text-blue-600 hover:underline">support@axolop.com</a></p>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-2 text-gray-700">
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><Link to="/security" className="text-blue-600 hover:underline">Security Practices</Link></li>
              </ul>
            </div>
          </section>
        </div>
