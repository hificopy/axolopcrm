...
export const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A1515]/20 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 ease-out",
  {
    variants: {
      variant: {
        default:
        ...
        accent:
          "btn-premium-red text-white hover:scale-[1.02] active:scale-[0.98] font-semibold tracking-tight",
        "accent-subtle":
          "bg-[#4A1515]/10 text-[#4A1515] hover:bg-[#4A1515]/20 border border-[#4A1515]/30 hover:border-[#4A1515]/50 hover:scale-[1.02] active:scale-[0.98]",
        "accent-gradient":
          "bg-gradient-to-r from-[#101010] via-[#4A1515] to-[#101010] text-white hover:shadow-2xl hover:scale-[1.02] active:scale-[0.98] font-semibold tracking-tight",
        ...
        link: "text-[#4A1515] underline-offset-4 hover:underline transition-all duration-200",
      },
      size: {
