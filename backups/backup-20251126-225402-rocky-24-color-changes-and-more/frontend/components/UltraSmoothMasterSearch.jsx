    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(26, 29, 36, 0.97) 0%, rgba(13, 15, 18, 0.99) 100%)",
            backdropFilter: "blur(40px)",
            border: "1px solid rgba(118, 27, 20, 0.3)",
            boxShadow:
              "0 0 60px rgba(118, 27, 20, 0.25), 0 25px 50px rgba(0, 0, 0, 0.4)",
          }}
        >
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <Search
                  className={`h-6 w-6 transition-colors duration-200 ${loading ? "text-[#761B14]/60" : "text-[#761B14]"}`}
                />
                {!loading && (
                  <div className="absolute inset-0 bg-[#761B14]/20 blur-xl" />
                )}
              </motion.div>
              <input
                ref={inputRef}
