...
function App() {
  ...
  // Show loading state
  if (isLoading) {
    return <FullPageLoader message="Loading Axolop..." />;
  }
        ...
        <Route path="/app" element={<MainLayout />}>
          ...
          {isLocalhost ? (
            ...
            <>
              ...
              <Route path="beta-access" element={<ProtectedRoute><BetaAccess /></ProtectedRoute>} />
              <Route path="test-user-type" element={<ProtectedRoute><TestUserType /></ProtectedRoute>} />
            </>
          )}
          ...
          <Route path="settings" element={isLocalhost ? <Settings /> : <ProtectedRoute><Settings /></ProtectedRoute>}>
            ...
            <Route path="agency" element={isLocalhost ? <AgencySettings /> : <ProtectedRoute><AgencySettings /></ProtectedRoute>} />
          </Route>
        </Route>
