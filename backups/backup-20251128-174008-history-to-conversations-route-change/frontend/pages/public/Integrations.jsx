        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="w-16 h-16 rounded-2xl bg-[#E92C92]/30 flex items-center justify-center mx-auto mb-6">
              <Puzzle className="w-8 h-8 text-[#E92C92]" />
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {popularIntegrations.map((integration, index) => (
              <motion.div
                ...
                className="p-4 rounded-xl bg-white/5 border border-gray-800/50 hover:border-[#E92C92]/50 transition-colors cursor-pointer"
              >
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div className="relative w-full lg:w-auto">
              ...
              <input
                ...
                className="w-full lg:w-64 pl-10 pr-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-[#E92C92]"
              />
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  {integration.status === 'available' && (
                    <button className="text-[#E92C92] text-sm font-medium hover:underline flex items-center gap-1">
      ...
      <section className="py-20 bg-gradient-to-b from-black to-[#E92C92]/20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Plus className="w-12 h-12 text-[#E92C92] mx-auto mb-4" />
