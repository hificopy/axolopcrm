          ...
          <div className="flex items-center justify-center gap-4 mb-4 fade-in-up delay-400">
            ...
            <button
              ...
              className={cn(
                ...
                isYearly ? 'bg-[#E92C92]' : 'bg-gray-700'
              )}
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    'stagger-fade-in',
                    plan.popular
                      ? 'bg-gradient-to-br from-[#E92C92]/30 via-[#E92C92]/20 to-transparent border-2 border-[#E92C92] md:scale-105'
                      : 'bg-white/[0.02] border border-gray-800/50 hover:border-[#E92C92]/30'
                  )}
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  {/* Popular badge */}
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#E92C92] to-[#C81E78] text-white text-xs font-bold uppercase tracking-wide shadow-lg">
                      Most Popular
                    </div>
                  )}
                  ...
                  <div className="mb-6">
                    <div className="flex items-center gap-3 mb-3">
                      <div className={cn(
                        ...
                        plan.popular ? 'bg-gradient-to-br from-[#E92C92] to-[#C81E78]' : 'bg-[#E92C92]/20'
                      )}>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      plan.popular
                        ? 'bg-gradient-to-r from-[#E92C92] to-[#C81E78] text-white hover:from-[#5B1046] hover:to-[#E92C92] shadow-lg hover:shadow-[#E92C92]/50'
                        : 'bg-white/5 text-white hover:bg-white/10 border border-gray-700 hover:border-[#E92C92]'
                    )}
                  >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {TOOLS_REPLACED.map((tool, index) => (
              <div
                key={tool.name}
                className="p-6 rounded-2xl bg-white/[0.02] border border-gray-800/50 text-center stagger-fade-in hover-lift transition-all duration-300 hover:border-[#E92C92]/30"
          ...
          <div className="p-8 rounded-3xl bg-gradient-to-br from-[#E92C92]/20 via-[#E92C92]/10 to-transparent border border-[#E92C92]/30 text-center fade-in-up">
            ...
            {[
              ...
              return (
                <div
                  ...
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#E92C92]/20 border border-[#E92C92]/40 flex items-center justify-center mb-3 hover-lift">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {FAQS.map((faq, index) => (
              <div
                key={faq.question}
                className="border border-gray-800/50 rounded-2xl overflow-hidden bg-white/[0.02] stagger-fade-in hover:border-[#E92C92]/30 transition-colors"
                style={{ animationDelay: `${index * 50}ms` }}
              >
                <button
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="fade-in-up">
            ...
            <Link
              to="/signup"
              className="inline-flex items-center gap-2 px-10 py-5 rounded-full relative group overflow-hidden transition-all duration-200"
              style={{
            ...
            >
              ...
              <ChevronRight className="w-5 h-5 text-white/90 transition-transform group-hover:translate-x-1" />
