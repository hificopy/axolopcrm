          ...
          <section className="mb-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-blue-50 border border-gray-200 rounded-lg p-4 text-center">
                <Server className="h-8 w-8 text-[#3F0D28] mx-auto mb-2" />
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                <Link to="/dpa" className="text-[#3F0D28] hover:underline ml-1">View our DPA</Link>
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                issue, please report it to <a href="mailto:security@axolop.com" className="text-[#3F0D28] hover:underline">security@axolop.com</a>.
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <div className="bg-gray-50 rounded-lg p-4">
                <p><strong>Security Issues:</strong> <a href="mailto:security@axolop.com" className="text-[#3F0D28] hover:underline">security@axolop.com</a></p>
                <p><strong>Privacy Inquiries:</strong> <a href="mailto:privacy@axolop.com" className="text-[#3F0D28] hover:underline">privacy@axolop.com</a></p>
                <p><strong>General Support:</strong> <a href="mailto:hello@axolop.com" className="text-[#3F0D28] hover:underline">hello@axolop.com</a></p>
              </div>
            </div>
          </section>
