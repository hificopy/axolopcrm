...
export default function Dashboard() {
  ...
  const [currentPreset, setCurrentPreset] = usePersistentState("dashboard_preset", "default");
  const [timeRange, setTimeRange] = usePersistentState("dashboard_timeRange", "month");
  // Regular state
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-black/[0.06] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-shadow">
            ...
            <p className="text-sm text-neutral-400 mt-1">
              ${((dashboardData.sales?.allTimeRevenue || 0) / 1000).toFixed(0)}k All Time
            </p>
          </div>
          {/* Active Leads */}
          <div className="bg-white rounded-2xl border border-black/[0.06] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-shadow">
