...
const settingsNavigation = [
  {
    ...
    sections: [
      ...
      {
        name: "Appearance",
        href: "/app/settings/account?tab=appearance",
        icon: LayoutDashboard,
        locked: true,
        featureCategory: "account",
        featureKey: "appearance",
      },
      {
        name: "Memberships",
        href: "/app/settings/account?tab=membership",
        icon: Key,
      },
    ],
  },
  {
    ...
    icon: Building,
    sections: [
      { name: "General", href: "/app/settings/agency/general", icon: Building },
      {
        name: "Team Management",
        href: "/app/settings/agency/team",
        icon: Users,
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        href: "/app/settings/customization/links",
        icon: Zap,
      },
      {
        name: "Scheduling Links",
        href: "/app/settings/customization/scheduling",
        icon: Clock,
      },
      {
        name: "Statuses & Pipelines",
        href: "/app/settings/customization/statuses",
        icon: Zap,
      },
      {
        name: "AI Knowledge Sources",
        href: "/app/settings/customization/ai",
        icon: Code,
        locked: true,
        featureCategory: "customization",
        featureKey: "aiKnowledge",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        href: "/app/settings/communication/phone",
        icon: Phone,
        locked: true,
        featureCategory: "communication",
        featureKey: "phone",
      },
      {
        name: "Dialer",
        href: "/app/settings/communication/dialer",
        icon: Phone,
        locked: true,
        featureCategory: "communication",
        featureKey: "dialer",
      ...
      {
        name: "Outcomes",
        href: "/app/settings/communication/outcomes",
        icon: Zap,
        locked: true,
        featureCategory: "communication",
        featureKey: "outcomes",
      ...
      {
        name: "Notetaker BETA",
        href: "/app/settings/communication/notetaker",
        icon: Bell,
        locked: true,
        featureCategory: "communication",
        featureKey: "notetaker",
      },
      {
        name: "Email",
        href: "/app/settings/communication/email",
        icon: Mail,
        locked: true,
        featureCategory: "communication",
        featureKey: "email",
      },
      {
        ...
        href: "/app/settings/communication/templates",
        icon: Mail,
        locked: true,
        featureCategory: "communication",
      ...
      {
        name: "Send As",
        href: "/app/settings/communication/sendas",
        icon: Mail,
        locked: true,
        featureCategory: "communication",
        featureKey: "sendAs",
  ...
  },
  {
    ...
    sections: [
      {
        name: "Integrations",
        href: "/app/settings/integrations/integrations",
        icon: Plug,
      },
      {
        name: "Accounts & Apps",
        href: "/app/settings/integrations/accounts",
        icon: SettingsIcon,
      },
      {
        name: "Developer",
        href: "/app/settings/integrations/developer",
        icon: Code,
      },
    ],
  },
                  ...
                  {isExpanded && (
                    <div className="mt-2 space-y-1 pl-6">
                      {category.sections.map((section) => {
                        ...
                        if (section.locked) {
                          const version =
                            section.featureCategory && section.featureKey
                              ? getFeatureVersion(
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm cursor-not-allowed text-gray-300 bg-gray-100/50 dark:bg-gray-800/50">
                                <SectionIcon className="h-4 w-4 text-gray-300" />
                              ...
                              <div className="absolute left-0 bottom-full mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-[9999]">
                                <div className="bg-gray-900 text-white text-xs px-3 py-2 rounded-lg shadow-xl whitespace-nowrap border border-gray-700">
                                  ...
                                  <Link
                                    to="/roadmap"
                                    className="ml-1 text-[#3F0D28] hover:text-[#e85a50] pointer-events-auto underline"
                          ...
                          <Link
                            ...
                            className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                              isActive
                                ...
                                : "hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-900"
                            }`}
                          >
