...
export default function EmailMarketingWidget({ data }) {
  ...
  const isEmpty = sent === 0 && delivered === 0 && opened === 0 && clicked === 0;
        ...
        <CardContent className="flex-1 space-y-4 relative z-10">
          {isEmpty ? (
            ...
            >
              ...
              >
                <Mail className="h-8 w-8 text-[#3F0D28]/40" />
              </motion.div>
              ...
              <p className="text-sm text-crm-text-secondary mb-4 max-w-xs">
                Create your first email campaign to start tracking opens, clicks, and conversions
              </p>
              <motion.div
