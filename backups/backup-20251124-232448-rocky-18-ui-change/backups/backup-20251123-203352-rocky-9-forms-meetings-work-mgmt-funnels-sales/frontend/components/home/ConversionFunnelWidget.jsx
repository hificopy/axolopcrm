        ...
        <CardContent className="flex-1 pb-4 relative z-10">
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            <motion.div
              ...
              className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2 text-center border border-blue-200/50 dark:border-blue-700/50 hover:shadow-md transition-shadow"
            >
            ...
            >
              <div className="text-xs text-[#791C14] font-medium">Won</div>
