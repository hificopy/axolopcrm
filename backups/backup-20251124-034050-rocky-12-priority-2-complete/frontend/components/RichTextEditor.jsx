...
const RichTextEditor = ({
  ...
  const insertTodoList = useCallback(() => {
    ...
    checkbox.className = 'mt-1 accent-[#791C14]';
  ...
  const insertWikiLink = useCallback((noteTitle) => {
    ...
    link.className = 'text-[#791C14] hover:underline';
    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex items-center gap-1 p-2 border-b border-gray-700 bg-[#0a0a0a]">
        ...
        <div className="text-xs text-gray-500">
          Type <span className="text-[#791C14]">/</span> for commands, <span className="text-[#791C14]">[[</span> for links
        </div>
      </div>
      ...
      {showLinkAutocomplete && linkQuery && (
        ...
        >
          <div className="px-4 py-2 text-sm text-gray-400">
            Creating link to: <span className="text-[#791C14] font-medium">{linkQuery}</span>
          </div>
