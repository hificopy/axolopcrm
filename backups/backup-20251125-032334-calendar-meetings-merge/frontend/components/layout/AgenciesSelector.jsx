...
import { ChevronDown, Building2, Plus, Lock, Sparkles, Zap, Crown, X, Check, Upload, Image as ImageIcon, Trash2, Info, UserPlus, Link2 } from 'lucide-react';
...
const AgenciesSelector = () => {
  ...
  if (loading && agencies.length === 0 && !currentAgency) {
    return (
          ...
          <div className="flex items-center gap-1.5 relative">
            ...
            {showInfoTooltip && (
              <div className="absolute left-0 top-full mt-1 z-50 w-48 p-2 bg-gray-800 border border-gray-600 rounded-lg shadow-xl text-xs text-gray-300 font-normal normal-case tracking-normal">
                <p className="font-medium text-white mb-1">What are Agencies?</p>
                <p>Agencies are separate workspaces for different clients or projects. Each agency has its own data, team members, and settings.</p>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={plusMenuRef}>
              <button
                ...
                title={isAdmin && isAdmin() ? 'Agency options' : canCreateMore ? 'Create new agency' : 'Upgrade to create more agencies'}
              >
                {(isAdmin && isAdmin()) || canCreateMore ? <Plus className="h-4 w-4" /> : <Lock className="h-4 w-4" />}
              </button>
              ...
              {showPlusMenu && createPortal(
                <div
                  ...
                  style={{
                    bottom: (window.innerHeight - plusMenuRef.current?.getBoundingClientRect().top + 8) + 'px',
                    left: plusMenuRef.current?.getBoundingClientRect().left + 'px',
                  }}
                >
                  <div className="py-1">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Start a new workspace</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Add to {currentAgency?.name || 'agency'}</p>
                      </div>
                    </button>
                  </div>
                </div>,
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                  ...
                  <button
                    ...
                    className="w-full p-3 rounded-lg hover:bg-purple-500/10 transition-all cursor-pointer border border-transparent hover:border-purple-500/20 flex items-center gap-3"
                  >
                    <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-purple-500/20 to-blue-500/20 flex items-center justify-center ring-1 ring-purple-500/30">
