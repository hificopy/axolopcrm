...
const USE_CASES = [
  ...
  },
  {
    ...
    icon: Briefcase,
    challenge: 'Slow sales cycles and manual data entry eating into selling time',
...
const colorStyles = {
  red: {
    gradient: 'from-[#761B14]/20 to-[#d4463c]/10',
    border: 'border-[#761B14]/30',
    iconBg: 'bg-[#761B14]/20',
    iconText: 'text-[#d4463c]',
    badgeBg: 'bg-[#761B14]/20',
    badgeText: 'text-[#d4463c]',
  },
  teal: {
...
/**
 * UseCaseSection - Industry-specific use case demonstrations
 */
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            See how agencies like yours are transforming their operations
            and boosting their bottom line with Axolop
          </p>
        </motion.div>
