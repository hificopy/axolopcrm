...
const StatCard = React.forwardRef(({
  ...
  const colorVariants = {
    ...
    accent: {
      bg: 'bg-[#791C14]/10 dark:bg-[#791C14]/20',
      text: 'text-[#791C14] dark:text-[#d4463c]',
      border: 'border-[#791C14]/20 dark:border-[#791C14]/40',
      hover: 'group-hover:bg-[#791C14]/15 dark:group-hover:bg-[#791C14]/30'
    },
    gray: {
    ...
    >
      ...
      <div className="flex items-baseline justify-between">
        <div className={cn(
          ...
          color === 'accent' && "group-hover:text-[#791C14]"
        )}>
          {value}
        </div>
