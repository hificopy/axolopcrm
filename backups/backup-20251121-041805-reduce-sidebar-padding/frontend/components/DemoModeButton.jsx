  ...
  return (
    <div className="fixed top-3 z-50" style={{ right: '130px' }}>
      <button
        ...
        className={`relative h-10 w-10 flex items-center justify-center rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 group overflow-hidden backdrop-blur-sm ${
          isDemoMode
            ? 'bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800'
            : 'bg-gray-700/80 hover:bg-gray-600/80 active:bg-gray-800/80 hover:shadow-white/20'
        }`}
      >
