      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button
            variant="outline"
            size="default"
            className="bg-[#791C14] hover:bg-[#6b1a12] text-white border-none"
          >
            Export Report
          </Button>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 border border-gray-300 rounded-md bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#791C14]"
            >
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <div className="mb-6">
                ...
                <svg width="300" height="250" viewBox="0 0 300 250">
                  <path d="M 50 20 L 250 20 L 200 80 L 100 80 Z" fill="#e0e7ff" stroke="#791C14" strokeWidth="2" />
                  <path d="M 100 80 L 200 80 L 175 140 L 125 140 Z" fill="#c7d2fe" stroke="#791C14" strokeWidth="2" />
                  <path d="M 125 140 L 175 140 L 160 200 L 140 200 Z" fill="#a5b4fc" stroke="#791C14" strokeWidth="2" />
