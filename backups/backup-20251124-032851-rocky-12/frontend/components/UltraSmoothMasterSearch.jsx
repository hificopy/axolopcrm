...
const categoryConfig = {
  leads: {
    icon: UserPlus,
    label: 'Leads',
    color: 'from-[#791C14] via-[#8b2419] to-[#9b2c1e]',
...
export default function UltraSmoothMasterSearch({ isOpen, onClose }) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Premium Backdrop */}
        <div className="absolute inset-0 bg-gradient-to-br from-black/85 via-[#791C14]/15 to-black/85 backdrop-blur-xl" />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            ...
            className="absolute top-0 left-1/4 w-96 h-96 bg-[#791C14]/20 rounded-full blur-[120px]"
          />
        </div>
        ...
        >
          ...
          <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-transparent via-[#791C14] to-transparent" />
          ...
          <div className="relative">
            <div className="flex items-center gap-4 p-5 border-b border-white/10" style={{ backdropFilter: 'blur(20px)' }}>
              ...
              >
                <Search className={`h-6 w-6 transition-colors duration-200 ${loading ? 'text-[#791C14]/60' : 'text-[#791C14]'}`} />
                {!loading && <div className="absolute inset-0 bg-[#791C14]/20 blur-xl" />}
              </motion.div>
              <input
                ref={inputRef}
                type="text"
            ...
            <AnimatePresence mode="wait">
              {results.length === 0 && !loading && query.length >= 2 && (
                ...
                >
                  <div className="relative mb-6">
                    <div className="rounded-full bg-gradient-to-br from-[#791C14]/30 to-[#791C14]/10 p-6 backdrop-blur-xl border border-[#791C14]/30">
                      <Search className="h-12 w-12 text-[#791C14]" />
                    </div>
                    <motion.div
                      animate={{ scale: [1, 1.1, 1], opacity: [0.3, 0.5, 0.3] }}
                      transition={{ duration: 2, repeat: Infinity }}
                      className="absolute inset-0 bg-[#791C14]/20 blur-2xl rounded-full"
                    />
                  </div>
              ...
              {results.length === 0 && !loading && query.length < 2 && (
                ...
                >
                  <div className="relative mb-6">
                    <div className="rounded-full bg-gradient-to-br from-[#791C14]/30 to-[#791C14]/10 p-6 backdrop-blur-xl border border-[#791C14]/30">
                      <Sparkles className="h-12 w-12 text-[#791C14]" />
                    </div>
                    <motion.div
                        ...
                        >
                          <button
                            ...
                            className={`w-full flex items-start gap-4 px-5 py-4 transition-all duration-150 ${
                              isSelected
                                ? 'bg-gradient-to-r from-[#791C14]/20 to-transparent border-l-2 border-[#791C14]'
                            ...
                            >
                              {config.actions.slice(0, 3).map((action) => (
                                <motion.button
                                  ...
                                  className="px-3 py-1 text-xs bg-white/10 hover:bg-[#791C14]/30 text-white rounded-lg backdrop-blur-sm border border-white/10 transition-colors"
                                >
                                  {action}
                                </motion.button>
                              ))}
          ...
          {/* Bottom Glow */}
          <div className="absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-[#791C14]/50 to-transparent" />
        </motion.div>
      </motion.div>
    </AnimatePresence>
  );
