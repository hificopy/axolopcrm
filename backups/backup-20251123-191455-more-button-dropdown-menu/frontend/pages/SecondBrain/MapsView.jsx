      ...
      <SecondBrainLayout>
        <div className="h-full min-h-screen flex items-center justify-center pt-[150px] bg-gray-50 dark:bg-gray-900">
          <div className="text-center">
            <Network className="w-16 h-16 text-[#7b1c14] mx-auto mb-4 animate-spin" />
      ...
      <div className="relative h-screen w-screen flex flex-col bg-gray-50 dark:bg-gray-900 p-0 m-0">
        ...
        <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
                ...
                {maps.map(map => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${
                      currentMap?.id === map.id ? 'bg-gray-100 dark:bg-gray-700 text-[#7b1c14]' : 'text-gray-900 dark:text-white'
                    }`}
                  >
                    {map.name}
                  </button>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#7b1c14] hover:bg-[#651610] text-white rounded-lg transition-colors shadow-lg"
          >
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden bg-gray-50 dark:bg-gray-900">
          {currentMap ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <Network className="w-24 h-24 text-[#7b1c14] mx-auto mb-6 opacity-50" />
                ...
                <button
                  onClick={handleCreateNewBoard}
                  className="px-6 py-3 bg-[#7b1c14] hover:bg-[#651610] text-white rounded-lg transition-colors shadow-lg"
                >
                  Create Board
                </button>
              </div>
