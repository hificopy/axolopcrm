        ...
        <>
          ...
          <motion.div
            ...
            className={cn(
              ...
              'bg-gradient-to-br from-[#1E1B24] via-[#140516] to-[#0A030B]',
              'border-l border-[#2E0F2F]/50',
              'shadow-2xl',
              'overflow-y-auto'
            )}
          >
            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-6">
                ...
                {/* Roadmap Card - Visually Stunning with Branded Magenta */}
                <Link
                  to="/roadmap"
                  className={cn(
                    'group flex items-center justify-between mt-4 p-4 rounded-xl',
                    'bg-gradient-to-r from-[#E92C92]/40 via-[#5B1046]/40 to-[#E92C92]/30',
                    'border border-[#E92C92]/40',
                    'hover:border-[#C81E78]/50',
                    'transition-all duration-300'
                  )}
                  onClick={handleLinkClick}
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#E92C92] to-[#5B1046] flex items-center justify-center shadow-[0_0_15px_rgba(233,44,146,0.4)]">
                      <Map className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-semibold text-white">Roadmap</span>
                        <span className="px-2 py-0.5 text-[10px] font-bold rounded-full bg-[#1A777B] text-white uppercase">
                          Live
                        </span>
                      </div>
              ...
              {/* CTA Buttons */}
              <div className="space-y-3 pt-4 border-t border-[#2E0F2F]/50">
                <Button
                  className={cn(
