...
const settingsNavigation = [
  {
    ...
    sections: [
      ...
      {
        name: "Appearance",
        href: "/settings/account?tab=appearance",
        icon: LayoutDashboard,
        locked: true,
      },
      {
        name: "Memberships",
        href: "/settings/account?tab=membership",
        icon: Key,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        href: "/settings/organization/permissions",
        icon: Shield,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        href: "/settings/customization/links",
        icon: Zap,
      },
      {
        name: "Scheduling Links",
        href: "/settings/customization/scheduling",
        icon: Clock,
      },
      {
        name: "Statuses & Pipelines",
        href: "/settings/customization/statuses",
        icon: Zap,
      },
      {
        name: "AI Knowledge Sources",
        href: "/settings/customization/ai",
        icon: Code,
        locked: true,
      },
    ],
    ...
    sections: [
      {
        ...
        href: "/settings/communication/phone",
        icon: Phone,
        locked: true,
      },
      {
        name: "Dialer",
        href: "/settings/communication/dialer",
        icon: Phone,
        locked: true,
      },
      {
        name: "Outcomes",
        href: "/settings/communication/outcomes",
        icon: Zap,
        locked: true,
      },
      {
        name: "Notetaker BETA",
        href: "/settings/communication/notetaker",
        icon: Bell,
        locked: true,
      },
      {
        name: "Email",
        href: "/settings/communication/email",
        icon: Mail,
        locked: true,
      },
      {
      ...
      {
        name: "Send As",
        href: "/settings/communication/sendas",
        icon: Mail,
        locked: true,
      },
    ],
  },
  {
    ...
    sections: [
      {
        name: "Integrations",
        href: "/settings/integrations/integrations",
        icon: Plug,
      },
      {
        name: "Accounts & Apps",
        href: "/settings/integrations/accounts",
        icon: SettingsIcon,
      },
      {
        name: "Developer",
        href: "/settings/integrations/developer",
        icon: Code,
      },
    ],
  },
