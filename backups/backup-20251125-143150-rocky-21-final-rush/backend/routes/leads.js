...
router.post("/import", authenticateUser, requireEditPermissions, async (req, res) => {
  try {
...
router.post("/presets", authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
...
router.get("/industry-template/:industryId", authenticateUser, async (req, res) => {
  try {
