...
const KateOnboarding = ({ onComplete }) => {
  ...
  if (showHearts) {
    // Hearts animation
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#791C14] via-[#a03323] to-[#d96b5c] flex items-center justify-center overflow-hidden relative">
        ...
        >
          ...
          >
            <div className="relative inline-block">
              <div className="absolute -inset-4 bg-gradient-to-r from-[#791C14] to-[#d96b5c] rounded-full blur-lg opacity-30"></div>
              <Heart className="w-24 h-24 text-[#791C14] mx-auto relative z-10" fill="currentColor" />
            </div>
          </motion.div>

          <motion.h1
            className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-[#791C14] via-[#a03323] to-[#d96b5c] bg-clip-text text-transparent mb-8"
          ...
          >
            ...
            <p className="text-2xl font-semibold text-[#791C14] mt-8">
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-[#791C14] to-[#d96b5c] hover:from-[#a03323] hover:to-[#e68a77] text-white px-10 py-5 text-xl rounded-xl shadow-xl font-bold transition-all duration-300 transform hover:scale-105"
            >
