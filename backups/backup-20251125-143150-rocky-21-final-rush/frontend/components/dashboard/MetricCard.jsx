...
export default function MetricCard({
  ...
  return (
    ...
    >
      <Card
        className="h-full w-full overflow-hidden bg-white border border-black/[0.05] shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all duration-300 relative"
      >
