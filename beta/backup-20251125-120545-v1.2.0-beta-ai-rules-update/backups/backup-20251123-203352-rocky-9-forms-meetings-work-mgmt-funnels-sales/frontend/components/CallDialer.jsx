      ...
      <div className="bg-gradient-to-r from-[#101010] to-[#2d2d2d] text-white p-4 rounded-t-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 bg-[#791C14] rounded-full flex items-center justify-center">
              <User size={24} />
            </div>
            <div>
        ...
        {callStatus === 'active' && (
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <button
              ...
              className="px-4 py-2 border border-[#791C14] text-[#791C14] rounded-lg hover:bg-red-50 flex items-center justify-center space-x-2"
            >
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#791C14] focus:border-transparent"
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 px-4 py-2 bg-[#791C14] text-white rounded-lg hover:bg-[#5a1410] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Save & Next
              </button>
              <button
