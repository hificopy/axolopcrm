...
export default function Onboarding() {
  ...
  useEffect(() => {
    ...
    // God users bypass all onboarding restrictions
    if (isGodUser) {
      console.log("[Onboarding] God user detected - allowing access");
      return;
    }

    // Only allow access if coming from payment (for non-God users)
