...
export default function AgencySettings() {
  ...
  const { getMemberRoles, agencyRoles } = useRoles();
  ...
  const loadMembers = async () => {
    ...
    try {
      ...
      const rolesPromises = (data || []).map((member) =>
        getMemberRoles(member.user_id).catch(() => []),
      );
  ...
  // Show loading state while agency context is loading
  if (agencyLoading) {
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin text-[#3F0D28] mx-auto mb-4" />
          <p className="text-gray-300">Loading agency settings...</p>
        </div>
      </div>
    );
  }

  // If no agency selected but agencies exist, try to auto-select
  if (!currentAgency && agencies && agencies.length > 0) {
    selectAgency(agencies[0].agency_id);
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin text-[#3F0D28] mx-auto mb-4" />
          <p className="text-gray-300">Selecting agency...</p>
        </div>
      </div>
    );
  }

  // No agencies at all - prompt to create one
  if (!currentAgency) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-gray-300 mb-4">
          Create or select an agency to manage settings
        </p>
        <button
          onClick={() => navigate("/app/home")}
          className="px-4 py-2 bg-[#3F0D28] hover:bg-[#5a1a3a] text-white rounded-lg transition-colors"
        >
          Go to Dashboard
        </button>
      </div>
    ...
    <>
      <div className="p-8">
                  ...
                  <div>
                    ...
                    <span
                      className={`font-medium ${
                        currentAgency.max_users - members.length > 0
                          ? "text-green-400"
                          : "text-red-400"
                      }`}
                    >
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 flex-wrap mt-1">
                          ...
                          {/* Default role badge if no custom roles */}
                          {(!memberRoles[member.user_id] ||
                            memberRoles[member.user_id].length === 0) && (
        ...
        {activeTab === "branding" && (
          <div className="space-y-6">
            {/* Header */}
            <div className="bg-gradient-to-r from-[#3F0D28]/10 to-yellow-500/10 border border-[#3F0D28]/30 rounded-lg p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-[#3F0D28]/20 ring-2 ring-[#3F0D28]/30">
                  <Palette className="h-6 w-6 text-[#3F0D28]" />
                </div>
                <div>
                  ...
                  return (
                    <button
                      ...
                      className={`relative p-4 rounded-xl border-2 transition-all duration-200 text-left group ${
                        isSelected
                          ? "border-[#3F0D28] bg-[#3F0D28]/10 ring-2 ring-[#3F0D28]/30"
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        {isSelected && (
                          <div className="p-1 rounded-full bg-[#3F0D28]">
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                      ...
                      (currentAgency?.settings?.theme || "default")
                        ...
                        : "bg-gradient-to-r from-[#3F0D28] to-[#5a1a3a] hover:from-[#5a1a3a] hover:to-[#2a0919] text-white shadow-lg hover:shadow-[#3F0D28]/30"
                    }`}
                  >
                    {savingTheme ? (
                      <>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="px-4 py-2 bg-green-100 border border-green-200 rounded-lg">
                <span className="text-green-800 font-semibold text-sm">
                  Current Plan: {getSubscriptionTier()?.toUpperCase() || "FREE"}
                </span>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-black">
                    {getSubscriptionTier()?.toUpperCase() || "FREE"}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-700">Agency Seats</span>
                  <span className="font-medium text-black">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
              ...
              <p className="text-gray-600 mb-6">
                Unlock more features and remove limitations by upgrading your
                subscription
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex justify-between items-start mb-2">
                    <h5 className="text-lg font-bold text-black">Build</h5>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>1 Agency
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>3 Team Seats
                    </li>
                    <li className="flex items-center gap-2">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex justify-between items-start mb-2">
                    <h5 className="text-lg font-bold text-black">Scale</h5>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>3 Agencies
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>
                      10 Team Seats
                  ...
                  <button className="w-full mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition-colors">
                    Upgrade to Scale
                  </button>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex justify-between items-start mb-2">
                    <h5 className="text-lg font-bold text-black">Enterprise</h5>
                    <span className="px-2 py-1 bg-gray-800 text-white text-sm font-semibold rounded">
                      CUSTOM
                    </span>
                  </div>
                  <div className="text-2xl font-bold text-black mb-2">
                  ...
                  <button className="w-full mt-4 px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white font-semibold rounded-lg transition-colors">
                    Contact Sales
                  </button>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <div>
                    <p className="font-medium text-black">Current Period</p>
                    <p className="text-sm text-gray-600">
                      Dec 1, 2024 - Dec 31, 2024
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-black">$97.00</p>
                    <p className="text-xs text-gray-500">Paid</p>
                  </div>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <div>
                    <p className="font-medium text-black">Next Period</p>
                    <p className="text-sm text-gray-600">
              ...
              <button className="w-full mt-4 px-4 py-2 bg-black hover:bg-gray-800 text-white font-semibold rounded-lg transition-colors">
