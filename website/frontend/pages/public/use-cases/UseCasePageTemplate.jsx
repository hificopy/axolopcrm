              ...
              {solutions.map((solution, index) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    className="p-6 rounded-2xl bg-gradient-to-br from-[#E92C92]/10 to-[#14787b]/10 border border-gray-800/50 hover:border-gray-700/50 transition-colors"
                  >
                    <div className="flex items-start gap-4">
                      {SolutionIcon && (
                        <div
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Quote className="w-8 h-8 text-[#E92C92] mb-4" />
                  <p className="text-gray-300 mb-4 italic">"{testimonial.quote}"</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#E92C92] to-[#E92C92] flex items-center justify-center text-white font-bold">
                ...
                <thead>
                  <tr className="border-b border-gray-800">
                    ...
                    <th className="py-4 px-4 text-center">
                      <span className="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-[#E92C92] to-[#E92C92] text-white text-sm font-bold">
                        Axolop
                      </span>
                    </th>
