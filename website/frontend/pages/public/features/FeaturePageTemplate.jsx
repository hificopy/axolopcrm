            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className={cn(
                  ...
                  "bg-gradient-to-r from-[#E92C92] to-[#C81E78]",
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-6 rounded-2xl backdrop-blur-sm bg-white/5 border border-gray-800/50 hover:border-gray-700/50 hover:bg-white/8 transition-all duration-300"
                  >
                    {FeatureIcon && (
                      <div
        ...
        <section className="py-20 bg-black">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-8 rounded-2xl bg-gradient-to-br from-[#E92C92]/20 to-[#1A777B]/10 border border-gray-800/50"
            >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">
              Join thousands of agency owners who have simplified their workflow
              with Axolop.
            </p>
            <Link
              to="/signup"
