      ...
      <Card className="h-full flex flex-col">
        <CardHeader>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-green to-green-600 flex items-center justify-center">
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-primary-blue to-blue-500"
                />
              </div>
            </div>
          </div>
