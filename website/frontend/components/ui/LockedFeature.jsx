...
export const LockedOverlay = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#3F0D28]/10 dark:bg-[#3F0D28]/20 border border-[#3F0D28]/30 rounded-lg p-4 max-w-md">
        <p className="text-sm text-[#3F0D28] dark:text-[#5a1a3a] text-center">
          ...
          <Link
            to="/roadmap"
            className="ml-1 text-[#3F0D28] dark:text-[#3F0D28] hover:underline"
          >
            View our roadmap
          </Link>
        </p>
