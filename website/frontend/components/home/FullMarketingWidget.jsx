        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="text-base font-semibold">Marketing Performance</CardTitle>
                <p className="text-xs text-crm-text-secondary">
                  Campaign metrics & analytics
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-blue-50 dark:bg-blue-950/30 border border-gray-200 dark:border-blue-900/50">
              <Calendar className="h-3 w-3 text-[#3F0D28] dark:text-[#3F0D28]" />
              <span className="text-xs font-semibold text-blue-700 dark:text-[#5a1a3a]">
