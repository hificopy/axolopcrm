  ...
  const handleSave = async (tab) => {
    try {
      ...
      switch (tab) {
        ...
        case "team":
          // Team management would be handled by separate API
          result = {
            success: true,
        ...
        case "permissions":
          // Role management would be handled by separate API
          result = {
            success: true,
        ...
        default:
          result = { success: true, data: organizationSettings };
      }
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-red-700 mt-1">
                              Custom Roles & Permissions requires an upgraded
                              plan
                            </p>
                            <Button
                              variant="default"
                      ...
                      <p className="text-crm-text-secondary mb-6">
                        Roles allow you to set which users are allowed to
                        perform certain actions within Close...
                      </p>
