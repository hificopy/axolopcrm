        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#14787b] to-[#1fb5b9] flex items-center justify-center shadow-lg">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-8 text-center shadow-sm">
            <div className="mx-auto h-16 w-16 rounded-full bg-gradient-to-br from-[#14787b]/10 to-[#1fb5b9]/10 flex items-center justify-center mb-6">
              <Folder className="h-8 w-8 text-[#14787b]" />
            </div>
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Advanced project management with integration to tools like
              Monday.com and Asana. Coming soon.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-lg mx-auto">
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <LayoutDashboard className="h-6 w-6 text-[#761B14] mb-2" />
                <span className="text-sm font-medium text-gray-700">
                  Boards
                </span>
              </div>
              <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col items-center">
                <Calendar className="h-6 w-6 text-[#d4463c] mb-2" />
                <span className="text-sm font-medium text-gray-700">
                  Timeline
                </span>
              </div>
