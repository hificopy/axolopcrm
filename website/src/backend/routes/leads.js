...
router.post('/import', protect, requireEditPermissions, async (req, res) => {
  try {
...
router.post('/presets', protect, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
...
router.put('/presets/:id', protect, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
...
router.delete('/presets/:id', protect, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
    const presetId = req.params.id;
...
router.post('/:id/verify', protect, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
    const leadId = req.params.id;
...
router.post('/:id/convert', protect, requireEditPermissions, async (req, res) => {
  try {
    const userId = req.user.id;
    const leadId = req.params.id;
