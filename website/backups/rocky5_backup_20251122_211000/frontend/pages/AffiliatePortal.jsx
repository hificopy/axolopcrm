        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              Join the Axolop CRM Affiliate Program
            </h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <StrategyCard
                  ...
                  description="Send personalized emails to your contacts introducing Axolop CRM"
                ...
                <StrategyCard
                  ...
                  description="Create blog posts, videos, or tutorials about Axolop CRM"
                  icon={<BarChart3 className="h-5 w-5" />}
                  tips={[
                    'Write comparison articles',
                    'Create tutorial videos',
                    'Share case studies',
                    'Review Axolop CRM features',
                  ]}
                />
                <StrategyCard
