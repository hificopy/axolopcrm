...
-- ============================================
-- 3. Verify forms table has required columns
-- ============================================
...
-- ============================================
-- 4. Create helper function for user preferences
-- ============================================
...
-- ============================================
-- 5. Create helper function to set user preference
-- ============================================
...
-- Check if forms table has new columns
-- SELECT
--   column_name,
--   data_type,
--   column_default
...
--   AND column_name IN ('workflow_nodes', 'endings');
...
-- ALTER TABLE public.forms DROP COLUMN IF EXISTS workflow_nodes;
-- ALTER TABLE public.forms DROP COLUMN IF EXISTS endings;
-- DROP FUNCTION IF EXISTS public.get_user_preference;
-- DROP FUNCTION IF EXISTS public.set_user_preference;
