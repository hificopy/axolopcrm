      ...
      >
        ...
        <div className="hidden lg:block">
          <MondayTable
            ...
            columns={columns}
            groups={leadGroups}
            onAddItem={canCreate() ? () => setIsCreateModalOpen(true) : undefined}
        ...
        <div className="fixed inset-0 sm:right-0 sm:left-auto sm:top-16 sm:bottom-0 w-full sm:w-96 bg-white dark:bg-[#1a1d24] border-l border-crm-border shadow-lg overflow-y-auto z-50 sm:z-auto">
          <div className="p-6 pt-20">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2">
              <Button variant="default" className="min-w-[40px] flex-1 sm:flex-none" onClick={handleConvertToOpportunity}>
                Convert to Opportunity
              </Button>
              <Button variant="outline" className="min-w-[40px] flex-1 sm:flex-none" onClick={handleAddContact}>
                Add Contact
              </Button>
            </div>
          </div>
