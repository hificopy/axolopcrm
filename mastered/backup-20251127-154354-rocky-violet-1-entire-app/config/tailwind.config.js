  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "crm-text-primary": "#E2E8F0", // Silver for dark mode
      ...
      backgroundImage: {
        ...
        // Purple radial glow
        "glow-radial": "radial-gradient(circle at 50% 0%, #5B1046 0%, #140516 60%)",
        // Primary button gradient
        "primary-gradient": "linear-gradient(to right, #D92683, #F43F5E)",
        // Plum sidebar gradient
        "sidebar-gradient": "linear-gradient(180deg, #1E1B24 0%, #140516 50%, #0A030B 100%)",
      },
    },
  },
