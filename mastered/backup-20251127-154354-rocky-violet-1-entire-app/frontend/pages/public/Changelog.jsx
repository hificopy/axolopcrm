        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="w-16 h-16 rounded-2xl bg-[#E92C92]/30 flex items-center justify-center mx-auto mb-6">
              <Rocket className="w-8 h-8 text-[#E92C92]" />
            </div>
              ...
              >
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 rounded-full bg-[#E92C92] flex items-center justify-center text-white text-xs font-bold">
      ...
      <section className="py-20 bg-gradient-to-b from-black to-[#E92C92]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Wrench className="w-12 h-12 text-[#E92C92] mx-auto mb-4" />
