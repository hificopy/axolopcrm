          ...
          <div className="text-center relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              {[...Array(20)].map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute w-2 h-2 bg-gradient-to-br from-[#3F0D28]/20 to-[#ff6b4a]/20 rounded-full"
                  initial={{
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="bg-gradient-to-br from-[#3F0D28] to-[#ff6b4a] p-8 rounded-full"
                    >
        ...
        >
          <div className="text-center relative">
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="inline-block rounded-full"
                >
                  <div className="bg-gradient-to-br from-[#3F0D28] to-[#ff6b4a] p-8 rounded-full">
            ...
            <motion.h1
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.5, duration: 0.8 }}
              className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-[#3F0D28] to-[#ff6b4a] bg-clip-text text-transparent mb-4"
            >
              {affiliateName
            ...
            >
              {[...Array(3)].map((_, i) => (
                <motion.div
                  key={i}
                  className="w-3 h-3 bg-gradient-to-r from-[#3F0D28] to-[#ff6b4a] rounded-full"
                  animate={{
                    scale: [1, 1.5, 1],
                    opacity: [0.5, 1, 0.5],
                  }}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="text-center">
            ...
            >
              <Brain className="w-16 h-16 text-[#3F0D28]" />
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              {affiliateRef && (
                <div className="absolute top-0 right-0">
                  <div className="bg-gradient-to-r from-[#3F0D28] to-[#ff6b4a] text-white px-6 py-2 rounded-bl-2xl shadow-lg">
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <div className="text-4xl font-bold text-[#3F0D28]">
                    {plan.price}
                  </div>
                  {plan.price !== "Custom" && (
            ...
            {recommendedPlan.setupRecommendations.length > 0 && (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <Zap className="w-6 h-6 text-[#3F0D28]" />
                ...
                <ul className="space-y-2">
                  {recommendedPlan.setupRecommendations.map((item, index) => (
                    <li key={index} className="flex items-center gap-3">
                      <Target className="w-5 h-5 text-[#3F0D28]" />
            ...
            >
              <Button
                ...
                className="relative overflow-hidden bg-gradient-to-r from-[#3F0D28] to-[#ff6b4a] hover:from-[#8b2c24] hover:to-[#ff7b5a] text-white text-xl px-12 py-8 rounded-xl shadow-xl transition-all duration-300 transform hover:scale-105"
              >
