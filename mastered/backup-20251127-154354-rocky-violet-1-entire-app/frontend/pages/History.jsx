...
const EVENT_TYPES = {
  ...
  OPPORTUNITY_CREATED: { icon: DollarSign, label: 'Opportunity Created', color: 'bg-[#1A777B]' },
  OPPORTUNITY_UPDATED: { icon: Edit, label: 'Opportunity Updated', color: 'bg-[#EBB207]' },
  OPPORTUNITY_WON: { icon: CheckCircle, label: 'Opportunity Won', color: 'bg-[#1A777B]' },
  OPPORTUNITY_LOST: { icon: XCircle, label: 'Opportunity Lost', color: 'bg-[#3F0D28]' },
        ...
        <div className="crm-stats-grid mt-6">
          ...
          <div className="bg-gradient-to-br from-[#1A777B]/5 to-[#1A777B]/10 rounded-xl p-5 border border-[#1A777B]/20 shadow-md hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs font-semibold text-[#1A777B] uppercase tracking-wide">Today</div>
                <div className="text-3xl font-bold text-neutral-900 dark:text-white mt-1">{stats.todayEvents}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-5 border border-[#3F0D28]/30 shadow-md hover:shadow-lg transition-all duration-300">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs font-semibold text-[#3F0D28] uppercase tracking-wide">This Month</div>
                <div className="text-3xl font-bold text-[#3F0D28] mt-1">{stats.thisMonthEvents}</div>
              </div>
            </div>
          </div>
        </div>
