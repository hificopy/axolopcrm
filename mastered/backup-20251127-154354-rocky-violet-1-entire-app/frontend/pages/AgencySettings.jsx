...
export default function AgencySettings() {
  const { currentAgency, isAdmin, refreshAgency, deleteAgency, loading: agencyLoading, agencies, selectAgency } = useAgency();
    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading agency settings...</p>
        </div>
      </div>
    );
  }
  ...
  if (!currentAgency && agencies && agencies.length > 0) {
    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin text-[#3F0D28] mx-auto mb-4" />
          <p className="text-gray-400">Selecting agency...</p>
        </div>
      </div>
    );
  }
  ...
  if (!currentAgency) {
    return (
      <div className="p-8 text-center">
        ...
        <h2 className="text-xl font-semibold text-white mb-2">No Agency Selected</h2>
        <p className="text-gray-400 mb-4">Create or select an agency to manage settings</p>
        <button
            ...
            <div className="bg-[#1a1d24] border border-gray-700 rounded-lg p-6">
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <div className="p-1 bg-blue-500/20 rounded">
                  <Palette className="h-4 w-4 text-[#3F0D28]" />
                </div>
                <div>
                  <p className="text-sm text-[#5a1a3a] font-medium">
                    Theme Scope
                  </p>
                  <p className="text-xs text-[#3F0D28]/80 mt-1">
