  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Gradient orbs */}
        <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#E92C92]/10 rounded-full blur-3xl" />
            ...
            >
              <div className="text-center flex flex-col items-center justify-center">
                <div
                  ...
                  className={cn(
                    "text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight tabular-nums",
                    "px-2 py-1 leading-tight",
                    "flex items-center justify-center text-center w-full",
                    stat.color === "vibrant" && "text-[#E92C92]",
                    stat.color === "teal" &&
