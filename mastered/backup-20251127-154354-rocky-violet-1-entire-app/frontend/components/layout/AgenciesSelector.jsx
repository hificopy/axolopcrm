  ...
  return (
    <>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={plusMenuRef}>
              ...
              {showPlusMenu &&
                createPortal(
                  <div
                    className="fixed w-48 bg-gradient-to-br from-[#1a0812] via-[#2a0919] to-[#1a0812] rounded-lg border border-[#3F0D28]/30 shadow-2xl shadow-[#3F0D28]/10 z-[9999] overflow-hidden backdrop-blur-xl"
                    style={{
                      bottom:
                        window.innerHeight -
                  ...
                  <div className="space-y-2 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                            ...
                            {agency.user_role === "admin" && (
                              <>
                                <button
                                  ...
                                  className="p-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all bg-blue-500/0 hover:bg-blue-500/20 text-gray-500 hover:text-[#3F0D28]"
                                  title="Edit agency"
                                >
                    ...
                    >
                      <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-[#3F0D28]/20 to-[#5a1a3a]/20 flex items-center justify-center ring-1 ring-[#3F0D28]/30">
                        <Link2 className="h-5 w-5 text-[#3F0D28]" />
                      </div>
      ...
      {showUpgradeModal &&
        createPortal(
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] animate-in fade-in duration-200">
            <div className="bg-gradient-to-br from-gray-900 via-[#3F0D28]/10 to-gray-900 border-2 border-[#3F0D28]/30 rounded-2xl p-8 max-w-lg w-full mx-4 shadow-2xl relative overflow-hidden">
