  ...
  if (error) {
    return (
      <div className="text-center py-8">
        ...
        <button
          onClick={fetchLogs}
          className="mt-2 text-[#3F0D28] hover:text-blue-800 text-sm"
        >
          Try again
        </button>
      </div>
    ...
    <div className={compact ? '' : 'bg-white rounded-lg border border-gray-200'}>
              ...
              {showFilters && (
                <button
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 text-sm rounded-md border ${
                    showFilterPanel ? 'bg-blue-50 border-gray-200 text-blue-700' : 'border-gray-200 text-gray-600 hover:bg-gray-50'
                  }`}
                >
      ...
      {!compact && filteredLogs.length >= limit && (
        <div className="px-6 py-4 border-t border-gray-200 text-center">
          <button className="text-sm text-[#3F0D28] hover:text-blue-800">
