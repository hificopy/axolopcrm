...
export const LazyEmailBuilder = lazy(
  () => import("../components/EmailBuilder"),
);
export const LazyFormBuilder = lazy(() => import("../components/FormBuilder"));
...
export const LazyDataGrid = lazy(() => import("../components/DataGrid"));

// Modal components - lazy load
export const LazyContactModal = lazy(
  () => import("../components/ContactModal"),
);
export const LazyLeadModal = lazy(() => import("../components/LeadModal"));
export const LazyOpportunityModal = lazy(
...
export const preloadCriticalComponents = () => {
  ...
  setTimeout(() => {
    ...
    preloadComponent(() => import("../components/DataGrid"));
  }, 2000);

  // Preload common modals
  setTimeout(() => {
    preloadComponent(() => import("../components/ContactModal"));
    preloadComponent(() => import("../components/LeadModal"));
  }, 3000);
};
...
export const lazyRoutes = {
  ...
  workflows: createLazyRoute(() => import("../pages/Workflows")),
