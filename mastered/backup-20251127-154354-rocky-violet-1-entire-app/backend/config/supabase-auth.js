...
console.log('🔑 Supabase Service Role Key:', supabaseServiceRoleKey ? 'SET (' + supabaseServiceRoleKey.substring(0, 20) + '...)' : 'NOT SET');
...
try {
  if (supabaseServiceRoleKey) {
    ...
    console.log('🔑 Service key role:', payload.role === 'service_role' ? 'service_role ✅' : `${payload.role} ❌ (should be service_role!)`);
  }
} catch (e) {
