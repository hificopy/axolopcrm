...
-- Add missing columns to agencies if they don't exist
DO $$
BEGIN
  -- Add owner_id if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'owner_id' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN owner_id UUID REFERENCES auth.users(id);
  END IF;
  -- Add slug if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'slug' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN slug TEXT;
  END IF;
  -- Add status if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'status' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN status TEXT DEFAULT 'active';
  END IF;
  -- Add settings if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'settings' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN settings JSONB DEFAULT '{}';
  END IF;
  -- Add metadata if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'metadata' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN metadata JSONB DEFAULT '{}';
  END IF;
  -- Add timezone if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'timezone' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN timezone TEXT DEFAULT 'UTC';
  END IF;
  -- Add size if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'size' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN size TEXT;
  END IF;
  -- Add industry if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'industry' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN industry TEXT;
  END IF;
  -- Add website if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'website' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN website TEXT;
  END IF;
  -- Add logo_url if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'logo_url' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN logo_url TEXT;
  END IF;
  -- Add description if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'description' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN description TEXT;
  END IF;
  -- Add created_at if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'created_at' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN created_at TIMESTAMPTZ DEFAULT NOW();
  END IF;
  -- Add updated_at if missing
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'updated_at' AND table_schema = 'public') THEN
    ALTER TABLE agencies ADD COLUMN updated_at TIMESTAMPTZ DEFAULT NOW();
  END IF;
END $$;

-- Index for agencies lookups (columns now guaranteed to exist)
