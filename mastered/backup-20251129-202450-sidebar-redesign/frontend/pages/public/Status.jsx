...
const INCIDENTS = [
  {
    ...
    status: "resolved",
    description:
      "Database optimization completed successfully. No service interruption occurred.",
    updates: [
  ...
  },
  {
    ...
    status: "resolved",
    description:
      "Some users experienced delays in email delivery. Issue has been resolved.",
    updates: [
  ...
  },
  {
    ...
    status: "resolved",
    description:
      "API response times were elevated for approximately 30 minutes.",
    updates: [
...
const Status = () => {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: "#0F0510" }}>
            ...
            >
              {allOperational ? (
                <>
                  ...
                  <span className="text-[#2DCE89] font-semibold">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-white/5 border border-gray-800/50">
            <div className="flex items-center gap-3">
              <Bell className="w-5 h-5 text-[#E92C92]" />
      ...
      {/* External Links */}
      <section className="py-12 bg-gradient-to-b from-black to-[#E92C92]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-400 mb-4">
            For real-time updates, follow us on Twitter or check our status
            page.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="https://twitter.com/axolopcrm"
              target="_blank"
