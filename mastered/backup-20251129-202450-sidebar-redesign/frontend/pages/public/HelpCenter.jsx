    ...
    <div className="min-h-screen text-white" style={{ background: '#0F0510' }}>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#E92C92]/10 rounded-full blur-3xl" />
        </div>
            ...
            <div className="relative max-w-xl mx-auto">
              ...
              <input
                ...
                className={cn(
                  ...
                  'focus:outline-none focus:border-[#E92C92]',
            ...
            {CATEGORIES.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#E92C92]/20 flex items-center justify-center flex-shrink-0">
                      <CategoryIcon className="w-5 h-5 text-[#E92C92]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-medium text-white group-hover:text-[#E92C92] transition-colors">
                        {category.title}
                      </h3>
                      <p className="text-sm text-gray-500">{category.articles} articles</p>
                    </div>
                    <ChevronRight className="w-5 h-5 text-gray-600 group-hover:text-[#E92C92] transition-colors" />
                  </Link>
                </motion.div>
              );
            })}
          ...
          <div className="space-y-2">
            {POPULAR_ARTICLES.map((article, index) => (
              ...
              >
                ...
                >
                  <div>
                    <h3 className="text-white group-hover:text-[#E92C92] transition-colors">
                      {article.title}
                    </h3>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-8 rounded-2xl bg-gradient-to-br from-[#E92C92]/20 to-[#14787b]/20 border border-gray-800/50 text-center"
          >
            <MessageSquare className="w-12 h-12 text-[#E92C92] mx-auto mb-4" />
