...
const Landing = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0F0510] text-white">
      ...
      <section
        ref={heroRef}
        className={`${affiliateName ? "pt-48" : "pt-28"} pb-20 px-4 sm:px-6 lg:px-8 relative overflow-x-hidden`}
      >
        ...
        >
          ...
          <div
            className="hero-dashboard-wrapper relative mx-auto max-w-full pt-10 pb-10 px-8"
            style={{
              perspective: "1500px",
