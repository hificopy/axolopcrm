      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
          <div className="p-6 text-center">
            <Lock className="h-12 w-12 text-[#3F0D28] mx-auto mb-4" />
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-[#3F0D28] to-[#5a1a3a] hover:from-[#5a1a3a] hover:to-[#a13328] text-white font-bold rounded-lg transition-all"
            >
              View Plans
            </button>
          </div>
      ...
      <div className="relative w-full max-w-lg bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="p-6 pb-0 text-center">
            <div className="inline-flex items-center justify-center p-4 rounded-2xl bg-gradient-to-br from-[#3F0D28]/20 to-[#5a1a3a]/20 ring-2 ring-[#3F0D28]/30 mb-4">
              <Lock className="h-8 w-8 text-[#3F0D28]" />
            </div>
          ...
          {/* Pricing Card */}
          <div className="p-6">
            <div className="bg-gradient-to-r from-[#3F0D28]/10 to-[#5a1a3a]/10 border border-[#3F0D28]/30 rounded-xl p-5">
          ...
          <div className="p-6 pt-0 space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-[#3F0D28] to-[#5a1a3a] hover:from-[#5a1a3a] hover:to-[#a13328] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-[#3F0D28]/30 flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {loading ? (
                <>Processing...</>
              ) : (
