  ...
  return (
    ...
    >
      <Card className="h-full w-full flex flex-col border-2 hover:border-opacity-60 hover:shadow-xl hover:shadow-red-500/20 transition-all duration-300 relative group overflow-hidden">
        ...
        <CardHeader className="pb-3 relative z-10">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              <motion.div
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-[#791C14] to-[#a03a2e] flex items-center justify-center flex-shrink-0 shadow-lg"
            ...
            <AreaChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              <defs>
                <linearGradient id="revenueGradient" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#791C14" stopOpacity={0.3}/>
                  <stop offset="95%" stopColor="#791C14" stopOpacity={0}/>
                </linearGradient>
              </defs>
        ...
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-br from-[#791C14] to-[#a03a2e] opacity-5 blur-3xl rounded-full -mb-16 -mr-16" />
      </Card>
    </motion.div>
  );
}
