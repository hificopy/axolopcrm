        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#7b1c14] to-[#a03a2e] flex items-center justify-center shadow-lg">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-8 text-center shadow-sm">
            <div className="mx-auto h-16 w-16 rounded-full bg-gradient-to-br from-[#7b1c14]/10 to-[#a03a2e]/10 flex items-center justify-center mb-6">
              <MessageSquare className="h-8 w-8 text-[#7b1c14]" />
            </div>
