  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl shadow-2xl shadow-black/30">
        ...
        <div className="bg-gradient-to-br from-[#7b1c14] via-[#5a1610] to-[#3d0f0b] rounded-xl border border-white/20">
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <div className="p-5">
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-base text-white/90">
                by sharing Axolop CRM with your network
              </p>
            </div>

            {/* Video Section - Compact */}
            <div className="mb-4 rounded-lg overflow-hidden bg-black/50 aspect-video relative group border border-white/20">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#ff6b4a]/20 to-[#7b1c14]/20">
              ...
              <div className="space-y-3">
                ...
                {userFirstName && userFirstName !== 'User' ? (
                  <p className="text-xs text-white/70 text-center">
                    Your personalized link will show "<span className="font-semibold text-white">{formatFirstName(userFirstName)}</span> invited you to try Axolop CRM" on the landing page
                  </p>
                ) : (
                  <p className="text-xs text-white/70 text-center">
