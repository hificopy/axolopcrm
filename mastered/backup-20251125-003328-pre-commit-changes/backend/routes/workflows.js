 ...
 */
router.put('/:id', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
    const {
 ...
 */
router.delete('/:id', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
 ...
 * Activate a workflow
 */
router.post('/:id/activate', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
 ...
 */
router.post('/:id/deactivate', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
 ...
 */
router.post('/:id/duplicate', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
 ...
 */
router.post('/:id/execute', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.user.id;
 ...
 */
router.post('/:workflowId/executions/:executionId/cancel', authenticateUser, requireEditPermissions, async (req, res) => {
  try {
    const { workflowId, executionId } = req.params;
    const userId = req.user.id;
