...
export default function OrganizationSettings() {
  ...
  const handleSave = (tab) => {
    console.log(`${tab} organization settings saved:`, tab === 'general' ? organizationSettings : {});
                            ...
                            <tr className="border-b border-gray-100">
                              <td className="py-3 px-4">
                                <div className="flex items-center gap-3">
                                  <div className="h-8 w-8 rounded-full bg-primary-blue flex items-center justify-center text-white text-sm font-semibold">
                                    JR
                                  </div>
                    ...
                    <div className="mb-6">
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <div className="flex items-start gap-3">
                          <svg className="h-5 w-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                          <div>
                            <h3 className="font-medium text-blue-900">Custom Roles & Permissions</h3>
                            <p className="text-sm text-blue-700 mt-1">
                              Custom Roles & Permissions requires an upgraded plan
                            </p>
                            <Button variant="default" className="mt-2 bg-blue-600 hover:bg-blue-700">
                              Upgrade Now
                            </Button>
                          </div>
                        </div>
